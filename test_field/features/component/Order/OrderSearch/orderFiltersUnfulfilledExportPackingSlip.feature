@BaseCase2 @Storefront @Admin @Order @Search @orderFiltersUnfulfilledExportPackingSlip
...
Feature: Check order delivery status filters
  ...
  @C8252 @C8252-1
  Scenario: Add date filter and status filter then export the packing slip
    ...
    Then 1st search label should contain "Delivery Status is Unfulfilled"
    Then I should see row of order links
