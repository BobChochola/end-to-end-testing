@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditNoneVariationIncreaseAndDecrease @fixture-shop @fixture-payment @fixture-delivery @EAT-726
Feature: Edit order after changing product variation
  As a merchant
  I want to edit order after changing the product variation from none to one
  ...
  Background:
    ...
    And I fill '(dirty data) Product with none variation' to english name field
    ...
    Then 1st row of product list should contain 'Product with none variation'

    Given I am on Shop Product Index Page
    When I input 'Product with none variation' to search field
    Then 1st product of products list should contain 'Product with none variation'
  ...
  @EAT-726-2 @EAT-726-2-2
  Scenario: Order edit with increasing / decreasing the amount of the product can not save
    ...
    And detail error message should contain 'product (variant) does not exist'
    ...
    Then 1st row of product list should not contain 'Product with none variation'