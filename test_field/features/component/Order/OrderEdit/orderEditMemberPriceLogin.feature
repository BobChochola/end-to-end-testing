@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditMemberPriceLogin @fixture-shop @fixture-payment @fixture-delivery
Feature:member price show when owner type is user
  ...
  @EAT-609 @EAT-609-2
  Scenario:login checkbox on order edit
