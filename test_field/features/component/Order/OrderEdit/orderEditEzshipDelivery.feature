@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditEzshipDelivery
@fixture-payment @fixture-delivery @fixture-product @fixture-shop
Feature: Can not edit delivery details of a ezship order
  As a merchant
  I want to edit delivery details of a ezship order
  So that I can not edit successful
  ...
  # @C3773
  # Scenario:  I can not edit delivery details of a ezship order
  ...
  #   And I should see id search button
  #   And I click on id search button
