@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditTwoVariationIncreaseAndDecrease @fixture-shop @fixture-delivery @fixture-payment @EAT-726
Feature: Edit order after changing product variation
  ...
  Scenario: Order edit with increasing / decreasing the amount of the product
    ...
    Then I click on reminder ok button
    And I should see product quantity field
    When I fill '1' to 1st product quantity field
