@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditAddMemberProductMember-6 @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Can add member product in order details with member accout
  ...
  @EAT-427 @EAT-427-6
  Scenario: Main product without member price--> show original price
