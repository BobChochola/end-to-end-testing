@BaseCase @Admin @Order @OrderEdit @orderEditsevenB2CArrived @fixture-seven-order
Feature: Order edit delivery details for recipient information
  ...
  @C3774 @C3774-3
  Scenario: (Arrived)I want to edit delivery details of customer's recipient information
    Given I am on Orders Page
    And I select Seven Eleven B2C Order Management of Orders delivery type dropdown
    Then I should see arrived tab
    When I click on arrived tab
    Then I should see search label
    And search label should contain "Ref. delivery status is Arrived"
    ...
    And delivery status should contain "Arrived"
    Then I Refresh
