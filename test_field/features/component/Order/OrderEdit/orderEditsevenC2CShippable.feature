@BaseCase @Admin @Storefornt @Order @OrderEdit @Setting @orderEditsevenC2CShippable @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Order edit delivery details for recipient information
  ...
  @C3775 @C3775-2
  Scenario: place an order first. (Shippable)I want to edit delivery details of customer's recipient information
    ...
    And I scroll down to payment type
    ...
    And search label should contain "Ref. delivery status is Shippable"
    ...
    Then I Refresh
    Then I scroll down to payment status dropdown
    ...
    And I should see execute shipment popover
