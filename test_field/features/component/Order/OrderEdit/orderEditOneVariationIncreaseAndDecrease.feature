@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditOneVariationIncreaseAndDecrease @fixture-shop @fixture-delivery @fixture-payment @EAT-726
Feature: Edit order after changing product variation
  As a merchant
  I want to edit order after changing the product variation from one to two
  ...
  Background:
    ...
    And I fill '(dirty data) Product with one variation' to english name field
    ...
    Then 1st row of product list should contain 'Product with one variation'

    Given I am on Shop Product Index Page
    When I input 'Product with one variation' to search field
    Then 1st product of products list should contain 'Product with one variation'
  ...
  @EAT-726-1 @EAT-726-1-2
  Scenario: Order edit with increasing / decreasing the amount of the product
    ...
    Then I should see detail error message
    Then detail error message should contain "product (variant) does not exist"
    Then I Refresh
    When I click on product details edit button
    Then I should see product details edit reminder
    Then I click on reminder ok button
    And I should see product quantity field
    When I fill '1' to product quantity field
    Then order refund should equal to "NT$10"
    And I click on product details save button
    Then I should see confirm popover
    And I click on yes button
    ...
    Then 1st row of product list should not contain 'Product with one variation'