@BaseCase @Admin @Storefront @Order @OrderEdit @mobile-orderEditAddMemberProductMember
@fixture-mobile-signup-p2 @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Can add member product in order details with member accout
  ...
  Scenario:  I can add member product in order details with member accout
