@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditAddMemberProductCustomer @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Can add member product in order details with customer accout
  As a merchant
  ...
  Scenario: I can add member product in order details with customer accout
    ...
    Then product list should not contain '(dirty data) 1st Member Product'