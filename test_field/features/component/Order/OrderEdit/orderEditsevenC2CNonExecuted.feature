@BaseCase @Admin @Storefornt @Order @OrderEdit @Setting @orderEditsevenC2CNonExecuted @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Order edit delivery details for recipient information
  ...
  Scenario: (Non-executed)I want to edit delivery details of customer's recipient information
    ...
    And I fill "shopline" to customer field
