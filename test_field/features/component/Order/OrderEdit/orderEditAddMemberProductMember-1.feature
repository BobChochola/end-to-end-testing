@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditAddMemberProductMember-1 @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Can add member product in order details with member accout
  ...
  @EAT-427 @EAT-427-1
  Scenario: Main product with member price --> show member price
