@BaseCase @Admin @Order @OrderEdit @Setting @Product @MemberTier @memberTierPriceOrderEditNewCustomer @EAT-977 @fixture-delivery @fixture-payment
Feature: member price tier product order edit(add/increase/decrease/delete) - without logging in
  As a user of Shopline
  I want to edit order with member tier products
  So that order can be saved sucessfully (price should not display member tier price)
  ...
  @EAT-977-3
  Scenario: member price tier product order edit(add/increase/decrease/delete) - without logging in
    ...
    When I fill '2' to 3rd product quantity field
    ...
    Then order account details should contain 'This order is non-logged in check out, can NOT enjoy member offer.'
    Then row of product detail should contain '2 x NT$100'
    Then 2nd row of product detail should contain '2 x NT$50'
    Then 3rd row of product detail should contain '2 x NT$100'
    ...
    Then outstanding amount should contain "NT$250"
    And I click on product details save button
    Then I should see confirm popover
    And I click on YES button
    Then row of product detail should contain '5 x NT$100'
