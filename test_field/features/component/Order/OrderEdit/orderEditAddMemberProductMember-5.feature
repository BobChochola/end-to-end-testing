@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditAddMemberProductMember-5 @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Can add member product in order details with member accout
  ...
  @EAT-427 @EAT-427-5
  Scenario: Variation is same price as main product without member price--> show original price
