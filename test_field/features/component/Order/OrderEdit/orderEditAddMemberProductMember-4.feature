@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditAddMemberProductMember-4 @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Can add member product in order details with member accout
  ...
  @EAT-427 @EAT-427-4
  Scenario: Variation without member price--> show original price
