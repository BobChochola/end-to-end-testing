@BaseCase @Admin @Storefront @Order @OrderEdit @orderEditOneVariationAddAndDelete @fixture-shop @fixture-delivery @fixture-payment @EAT-726
Feature: Edit order after changing product variation
  ...
  Scenario: Order edit with adding new product and delete the original product
    ...
    And I input 'Product with one variation' to search field
    Then 1st product of product list should contain 'Product with one variation'
    And I click on 1st product of product list
    And I click on popup save button
    Then I should see color dropdown
    When I click on color dropdown option included 'R'
    When I click on color dropdown option included 'G'
