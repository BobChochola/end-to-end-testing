@BaseCase @Storefront @Admin @Order @OrderDelivery @orderExecuteShipmentSevenC2C
@fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Execute shipment of 7-11 C2C order
  As a merchant
  I want to Execute shipment of 7-11 C2C order
  ...
  @C3764 @C3764-16
  Scenario: Execute shipment of 7-11 C2C order
    ...
    Then I should see additional filters button
    Then row of order links should contain order number