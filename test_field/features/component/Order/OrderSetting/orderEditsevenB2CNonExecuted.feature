@BaseCase @Admin @Storefront @Order @Setting @orderEditsevenB2CNonExecuted @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Order edit delivery details for recipient information
  ...
  @C3774 @C3774-1
  Scenario: (Non-executed)I want to edit delivery details of customer's recipient information
    ...
    And I fill "shoplineapp" to customer field
    ...
    Then I should see non executed tab
    When I click on non executed tab
    Then I should see search label
    And search label should contain "Ref. delivery status is Pending"
