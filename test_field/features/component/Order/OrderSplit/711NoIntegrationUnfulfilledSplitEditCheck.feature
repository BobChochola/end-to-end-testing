@BaseCase @Admin @Storefront @Order @OrderSplit @711NoIntegrationUnfulfilledSplitEditCheck @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: 711 no integration unfulfilled order check the split button
  As a merchant
  ...
  Scenario: 711 no integration unfulfilled order check the split button
