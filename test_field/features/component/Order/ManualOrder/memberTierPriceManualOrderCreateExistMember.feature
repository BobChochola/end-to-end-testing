@BaseCase @Admin @Order @ManualOrder @Setting @Product @MemberTier @memberTierPriceManualOrderCreateExistMember @EAT-977 @fixture-delivery @fixture-payment
Feature: manually create member price tier product order - logged in
  As a user of Shopline
  I want to create order with member tier products
  So that order can be created sucessfully (price should display member tier price)
  ...
  @EAT-977-1
  Scenario: manually create member price tier product order - logged in
    ...
    Then row of product should contain 'NT$50'
    Then 2nd row of product should contain 'NT$5'
    ...
    Then row of product detail should contain '1 x NT$50'
    Then 2nd row of product detail should contain '1 x NT$5'
