@BaseCase @Admin @Order @Setting @CancelOrder @checkShopOrderCancelMemberRevertCredit @fixture-shop @fixture-product @fixture-payment @fixture-delivery @C17397 @C17431 @C17437
Feature: check shop order cancel flow detail and Auto revert credit. member/cash
  ...
  @EAT-1162 @EAT-1162-2
  Scenario: check shop order cancel flow detail and Auto revert credit. member/cash
    ...
    Then I should see row of credit list
    Then 1st row of credit list should contain "Credits reverted from cancelled order"
    And I wait for 5 seconds for mail sent
