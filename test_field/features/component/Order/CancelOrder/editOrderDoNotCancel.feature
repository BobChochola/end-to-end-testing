@BaseCase @Admin @Order @Setting @CancelOrder @editOrderDoNotCancel @fixture-shop @fixture-product @fixture-payment @fixture-delivery @C17444
Feature: after edit order should not see order cancel button on shop order show page
  As a user of Shopline
  I change order status should not see order cancel button on shop order show page
  ...
  @EAT-1162 @EAT-1162-9
  Scenario: after edit order should not see order cancel button on shop order show page
    ...
    When I fill '1' to 2nd product quantity field
    And I click on product details save button
    Then I should see confirm popover
    And I click on yes button
    And I click on product details save button
    Then row of product detail should contain '5 x NT$50'
    Then 2nd row of product detail should contain '1 x NT$25'
