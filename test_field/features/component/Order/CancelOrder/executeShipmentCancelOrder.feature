@BaseCase @Admin @Storefront @Order @CancelOrder @executeShipmentCancelOrder @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: Cancel order without pop up and still ship goods.
  As a user of Shopline
  I want check after order cancel still execute shipment
  ...
  @EAT-1163 @EAT-1163-1
  Scenario: cancel order before haven't cancel popover, after cancel order still execute shipment (family mart C2C)
    ...
    Then execute shipment popover should not contain "Attention"
    Then I should see execute shipment ok button
    ...
    Then order info should contain "Pending"
    ...
    Then popover should contain "Attention"
    And I click on OK button
    And I click on execute shipment ok button
    Then popover should contain "Execution result"
    And I click on OK button
    Then 1st row of activity log list should contain "Get Shipment Number"
