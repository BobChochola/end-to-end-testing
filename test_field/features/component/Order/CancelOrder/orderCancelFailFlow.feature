@BaseCase @Admin @Order @Setting @CancelOrder @orderCancelFailFlow @fixture-shop @fixture-product @fixture-payment @fixture-delivery
Feature: switch order cancel toggle to Off during shop cancel order, check cancel order popup fail
  As a user of Shopline
  I want check cancel order popup fail,
  close order cancel toggle during shop cancel order
  ...
  @EAT-1162 @EAT-1162-8
  Scenario: switch order cancel toggle to Off during shop cancel order, check cancel order popup fail
    ...
    Then I should see fail cancel popup 
