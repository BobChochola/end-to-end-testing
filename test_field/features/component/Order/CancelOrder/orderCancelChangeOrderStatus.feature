@BaseCase @Admin @Order @Setting @CancelOrder @orderCancelChangeOrderStatus @fixture-shop @fixture-product @fixture-payment @fixture-delivery @C17712
Feature: change order status should not see order cancel button on shop orders show page
  As a user of Shopline
  I can split the parent order when should not see order cancel button on shop order show page
  ...
  @EAT-1162 @EAT-1162-7-1
  Scenario: change order status should not see order cancel button on shop orders show page -order status
  ...
  @EAT-1162 @EAT-1162-7-2
  Scenario: change order status should not see order cancel button on shop order show page - payment status
    Given I am on Shop Product Index Page
    And I input "10th Product for Checkout" to search field
    Then 1st product of products list should contain '10th Product for Checkout'
    And I click on 1st product of products list
    ...
    And I click on 1st row of order links
    Then I should be redirected to Orders Show Page
    And I select Refunding of payment status dropdown
  ...
  @EAT-1162 @EAT-1162-7-3
  Scenario: change order status should not see order cancel button on shop order show page - delivery status
    Given I am on Shop Product Index Page
    And I input "10th Product for Checkout" to search field
    Then 1st product of products list should contain '10th Product for Checkout'
    And I click on 1st product of products list
    ...
    And I click on 1st row of order links
    Then I should be redirected to Orders Show Page
    When I select Arrived of update order delivery status dropdown
    And I click on send notification checkbox
    And I click on YES button
    Then order status should contain "Open"
    Then payment status should contain "Unpaid"
