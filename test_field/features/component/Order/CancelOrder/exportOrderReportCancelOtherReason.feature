@BaseCase @Admin @Storefront @Job @Order @CancelOrder @exportOrderReportCancelOtherReason @fixture-shop @fixture-product @fixture-payment @fixture-delivery @C18280

Feature: Check export order report have cancel reason type - other / check no reason error message and fill over 150 characters
  ...
  @EAT-1164 @EAT-1164-2
  Scenario: Check export order report have cancel reason type - other / check no reason error message and fill over 150 characters
    ...
    And I select reason for cancellation dropdown option included "Other" of reason for cancellation dropdown
    Then I should see reason area
    Then text limit should equal to '0/150'
    Then I click on confirm cancel button
    Then I should see error message
    Then error message should contain "Reason for cancellation is required"
    Then I fill more than 150 characters to reason area
    Then text limit should equal to '150/150'
    Then I click on confirm cancel button
    ...
    Then downloaded file from download button should contain only 150 characters
