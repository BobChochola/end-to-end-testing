@BaseCase @Admin @Order @OrderExport @Job @orderBulkExportStockPickingList
@fixture-shop @fixture-delivery @fixture-payment @fixture-product
Feature: Bulk export stock picking list - current page
  As a merchant
  I want to bulk export stock picking list
  ...
  @C3764 @C3764-5
  Scenario: Bulk export stock picking list by filtering date
    Given I am on Basic Setting Page
    When I mark the value of shop name field as variable shop name
    Given I am on Orders Page
    When I select export dropdown option included "Stock Picking List" of export dropdown
  ...
  @C3764 @C3764-8
  Scenario: Bulk export stock picking list from selected orders
    Given I am on Basic Setting Page
    When I mark the value of shop name field as variable shop name
    Given I am on Orders Page
    When I click on 1st row of order checkbox
    And I select export dropdown option included "Stock Picking List" of export dropdown
    Then I should see export popover
