@BaseCase2 @Admin @Job @Order @OrderExport @checkBulkExportPagesDownloadOrderInvoice
@fixture-shop @fixture-payment @fixture-delivery @fixture-product
Feature: Check the Bulk ImportExport Pages Switching and Downloading - Order Invoice
  ...
  @C7179 @C7179-3
  Scenario: Download the Order Invoice report
    ...
    And I wait for 150 seconds for loading
