@BaseCase2 @Admin @Job @Order @OrderExport @checkBulkImportExportPagesDownloadStockPickingList
@fixture-shop @fixture-delivery @fixture-payment @fixture-product
Feature: Check the Bulk ImportExport Pages Switching and Downloading - Picking List
  ...
  @C7179 @C7179-2
  Scenario: Download the Stock Picking List reprot
    ...
    Then status should not contain pending status
