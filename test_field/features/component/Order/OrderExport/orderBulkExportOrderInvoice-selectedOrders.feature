@PostTest @BaseCase @Admin @Order @OrderExport @Job @orderBulkExportOrderInvoice-selectedOrders
@fixture-shop @fixture-delivery @fixture-payment @fixture-product
Feature: Bulk export Order Invoice - selectedOrders
  As a merchant
  ...
  @C3764 @C3764-9
  Scenario: Bulk export order invoice from selected orders
