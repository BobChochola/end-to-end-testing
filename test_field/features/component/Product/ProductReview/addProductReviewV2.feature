@BaseCase @Admin @Storefront @Product @ProductReview @addProductReviewV2 @theme-kingsman @fixture-product @fixture-shop @fixture-payment @fixture-delivery @EAT-1044
Feature: Add product review and see the review at Shop Product Detail Page and Admin Customer Reviews Page(V2)
  As a merchant
  ...
  @EAT-1044-2
  Scenario: Add product review in v2
    ...
    And I select delivery address dropdown option included "Zhongzheng District" of 2nd delivery address dropdown
    ...
    Then I should be redirected to Shop Product View Comments Layout V Two Page
    ...
    Then I should be redirected to Shop Orders Layout V Two Page
    Then 2nd row of order number should contain order number
