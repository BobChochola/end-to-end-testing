@BaseCase @Admin @Storefront @Prodcut @Setting @MemberPrice @memberPriceCheckout9 
...
Feature: member price show various
  ...
  Scenario: variations are not same price as main produc price=0 & member price=0
    ...
    And I fill "(dirty data) variations price=0 & member price=0 Product" to english name field
    ...
    And I input "variations price=0 & member price=0 Product" to search field
    Then 1st product of products list should contain 'variations price=0 & member price=0 Product'
    ...
    # due to SL-15668
    # Then message list should contain message lists
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain '(dirty data) variations price=0 & member price=0 Product'