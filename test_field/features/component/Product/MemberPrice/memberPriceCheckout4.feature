@BaseCase @Admin @Storefront @Prodcut @Setting @MemberPrice @memberPriceCheckout4 
...
Feature: member price show various
  ...
  @EAT-484 @EAT-484-4
  Scenario: regular price=0, sale price=0, member price>0
    Given I am on Product Create Page
    When I pick product photo to product photo selector
    Then I should see delete photo button
    And I click on info tab
    And I fill "(dirty data) regular sale price=0 product" to english name field
    And I click on quantity and pricing tab
    And I fill "0" to regular price field
    And I fill "0" to sale price field
    ...
    And I input "regular sale price=0 product" to search field
    Then 1st product of products list should contain 'regular sale price=0 product'
    When I click on 1st product of products list
    Then I should be redirected to Shop Product Show Layout V Two Page
    Then regular price should not contain 'NT$'
    Then member price should contain "NT$10 Member Only"
    ...
    Then order total should contain "NT$10"
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain '(dirty data) regular sale price=0 product'