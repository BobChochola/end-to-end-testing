@BaseCase @Admin @Storefront @Prodcut @Setting @MemberPrice @memberPriceCheckout3 
...
Feature: member price show various
  ...
  @EAT-484 @EAT-484-3
  Scenario: price=0 & sale price>0 & member price>0
    Given I am on Product Create Page
    When I pick product photo to product photo selector
    Then I should see delete photo button
    And I click on info tab
    And I fill "(dirty data) regular price=0 product" to english name field
    ...
    And I input "regular price=0 product" to search field
    Then 1st product of products list should contain 'regular price=0 product'
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain '(dirty data) regular price=0 product'