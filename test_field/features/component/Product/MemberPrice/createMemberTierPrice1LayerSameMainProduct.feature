@BaseCase @ImageService @Admin @Setting @Product @MemberPrice @createMemberTierPrice1LayerSameMainProduct @EAT-976
Feature: Creat member tier price product 1 layer product and same price with main product
  ...
  @EAT-976-2
  Scenario: 1 layer product and price same as main product
    ...
    Then 1st row of product list should contain "1 layer product for member tier price"
