@BaseCase @Admin @Storefront @Prodcut @Setting @MemberPrice @memberPriceCheckout5 
...
Feature: member price show various
  ...
  @EAT-484 @EAT-484-5
  Scenario:  variations are same price as main product
    Given I am on Product Create Page
    When I pick product photo to product photo selector
    Then I should see delete photo button
    And I click on info tab
    And I fill "(dirty data) variations same price as mainProduct" to english name field
    ...
    And I input "variations same price as mainProduct" to search field
    Then 1st product of products list should contain 'variations same price as mainProduct'
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain '(dirty data) variations same price as mainProduct'