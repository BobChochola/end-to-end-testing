@BaseCase @Admin @Storefront @Prodcut @Setting @MemberPrice @memberPriceCheckout7 
...
Feature: member price show various
  ...
  Scenario: variations are not same price as main produc price=0 & member price>0
    ...
    And I fill "(dirty data) variation price=0 & member price>0 Product" to english name field
    ...
    And I fill "5" to 1st row of variation member price field
    ...
    And I input "variation price=0 & member price>0 Product" to search field
    Then 1st product of products list should contain 'variation price=0 & member price>0 Product'
    When I click on 1st product of products list
    Then I should be redirected to Shop Product Show Layout V Two Page
    Then regular price should not contain 'NT$'
    Then member price should contain "NT$5 Member Only"
    ...
    Then order total should contain "NT$5"
    ...
    Then row of product unit price should contain "NT$5"
    And ---ROLL BACK---
    Given I am on Product Setting Page
    Then I should see member price toggle
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain '(dirty data) variation price=0 & member price>0 Product'