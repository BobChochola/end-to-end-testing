@BaseCase @Admin @Storefront @Prodcut @Setting @MemberPrice @memberPriceCheckout2 
...
Feature: member price show various
  ...
  Scenario: price>0 & sale price=0 & member price>0
    ...
    And I fill "(dirty data) sale price=0 Product" to english name field
    ...
    And I input "sale price=0 Product" to search field
    Then 1st product of products list should contain 'sale price=0 Product'
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain '(dirty data) sale price=0 Product'