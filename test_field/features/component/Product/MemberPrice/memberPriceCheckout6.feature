@BaseCase @Admin @Storefront @Prodcut @Setting @MemberPrice @memberPriceCheckout6 
...
Feature: member price show various
  ...
  Scenario: variations are not same price as main produc price>0 & member price>0
    ...
    And I fill "(dirty data) var price>0 & member price>0 Product" to english name field
    ...
    And I input "var price>0 & member price>0 Product" to search field
    Then 1st product of products list should contain 'var price>0 & member price>0 Product'
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain '(dirty data) var price>0 & member price>0 Product'