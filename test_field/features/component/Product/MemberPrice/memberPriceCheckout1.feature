@BaseCase @Admin @Storefront @Prodcut @Setting @MemberPrice @memberPriceCheckout1 
...
Feature: member price show various
  ...
  Scenario: price>0 & sale price>0 & member price>0
    ...
    And I fill "(dirty data) all price product" to english name field
    ...
    And I input "all price product" to search field
    When I click on product of products list included 'all price product'
    Then I should be redirected to Shop Product Show Layout V Two Page
    Then regular price strikethrough should contain "NT$50"
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain '(dirty data) test free'