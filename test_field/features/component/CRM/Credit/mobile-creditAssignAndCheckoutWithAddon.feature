@BaseCase @Admin @Storefront @CRM @Credit @CouponCode @mobile-creditAssignAndCheckoutWithAddon
@fixture-mobile-signup-p2 @fixture-delivery @fixture-payment @fixture-product @fixture-promotion @fixture-shop
Feature: Mobile member Checkout - Assign credits and checkout with add-on item
  As a merchant
