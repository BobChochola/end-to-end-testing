@PostTest @PreTest @BaseCase @Admin @Storefront @CRM @Credit @CouponCode @creditAssignAndCheckoutWithPromotion @fixture-shop @fixture-product @fixture-promotion @fixture-payment @fixture-delivery
Feature: Assign credits and checkout with member promotion
  As a merchant
  ...
  Scenario: Assign credits and checkout with member promotion
    ...
    And I wait for 20 seconds for loading
