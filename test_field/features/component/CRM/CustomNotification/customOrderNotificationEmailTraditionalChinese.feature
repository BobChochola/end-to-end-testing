@BaseCase @Admin @Storefront @CRM @CustomNotification @customOrderNotificationEmailTraditionalChinese
@fixture-shop @fixture-product @fixture-delivery @fixture-payment @EAT-1001
Feature: Add custom text to email order notification header / footer and check email receive correctly（Traditional Chinese)
  As a merchant
  ...
  @EAT-1001-2
  Scenario: Custom Text and Traditional Chinese Support in Order notification email Header and Footer
    ...
    Then I should see zh email picture
    When I click on header edit button
    Then I should see editor toolbar
    Then I should see html text field
    When I input 'Order notification email header 中文 test' to 1st html text field
    ...
    Then I should be redirected to Custom Order Notification Page
    Then 1st html text field should contain 'Order notification email header 中文 test'
    ...
    When I input 'Order notification email footer 中文 test' to 2nd html text field
    ...
    Then 2nd html text field should contain 'Order notification email footer 中文 test'
    Then 2nd html text field should contain 'bold color background color'
    Then footer text count should contain '68/1000'
    ...
    And I select delivery address dropdown option included "100 中正區" of 2nd delivery address dropdown
    ...
    When I click on row of mail list included '謝謝你的訂單'
    Then I should see mail detail
    Then mail detail should contain 'Order notification email header 中文 test'
    Then mail detail should contain 'italic underline Font Size shop link'
    Then mail detail should contain 'Order notification email footer 中文 test'
    ...
    And I wait for 3 seconds for loading
    Then I should see row of mail list
    When I click on row of mail list included '訂單狀態 更新為: 已確認'
    Then I should see mail detail
    Then mail detail should contain 'Order notification email header 中文 test'
    Then mail detail should contain 'italic underline Font Size shop link'
    Then mail detail should contain 'Order notification email footer 中文 test'
