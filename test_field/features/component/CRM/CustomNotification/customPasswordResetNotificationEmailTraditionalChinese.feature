@BaseCase @Admin @Storefront @CRM @CustomNotification @customPasswordResetNotificationEmailTraditionalChinese
@fixture-shop @EAT-1005
Feature: Add custom text to email password reset notification header / footer and check email receive correctly（Traditional Chinese)
  As a merchant
  ...
  @EAT-1005-2
  Scenario: Custom Text and Traditional Chinese in password reset notification email Header and Footer
    ...
    When I input 'password reset notification email header 中文 test' to 1st html text field
    ...
    Then I should be redirected to Custom Password Reset Notification Page
    Then 1st html text field should contain 'password reset notification email header 中文 test'
    Then 1st html text field should contain 'italic underline Font Size shop link'
    Then header text count should contain '86/1000'

    When I click on footer edit button
    Then I should see 2 editor toolbar
    Then I should see 2 html text field
    When I input 'password reset notification email footer 中文 test' to 2nd html text field
    ...
    Then 2nd html text field should contain 'password reset notification email footer 中文 test'
    Then 2nd html text field should contain 'bold color background color'
    Then footer text count should contain '77/1000'
    ...
    When I click on row of mail list included '密碼重置請求'
    Then I should see mail detail
    Then mail detail should contain 'password reset notification email header 中文 test'
    Then mail detail should contain 'italic underline Font Size shop link'
    Then mail detail should contain 'password reset notification email footer 中文 test'
