@BaseCase @Admin @Storefront @CRM @CustomNotification @customUserRegisterNotificationEmailEnglish
@fixture-shop @EAT-1004
Feature: Add custom text to email user register notification header / footer and check email receive correctly（English)
  As a merchant
  ...
  @EAT-1004-1
  Scenario: Custom Text and English Support in user register notification email Header and Footer
    ...
    When I input 'user register notification email header test' to 1st html text field
    ...
    Then 1st html text field should contain 'user register notification email header test'
    Then 1st html text field should contain 'bold italic underline Font Size'
    Then header text count should contain '76/1000'

    When I click on footer edit button
    Then I should see 2 editor toolbar
    Then I should see 2 html text field
    When I input 'user register notification email footer test' to 2nd html text field
    ...
    Then I should be redirected to Custom Sign Up Notification Page
    Then 2nd html text field should contain 'user register notification email footer test'
    Then 2nd html text field should contain 'color background color shop link'
    Then footer text count should contain '78/1000'
    ...
    When I click on row of mail list included 'Welcome to'
    Then I should see mail detail
    Then mail detail should contain 'user register notification email header test'
    Then mail detail should contain 'bold italic underline Font Size'
    Then mail detail should contain 'user register notification email footer test'
