@BaseCase @Admin @Storefront @CRM @CustomNotification @customUserRegisterNotificationEmailSimplifiedChinese
@fixture-shop @fixture-multi-lang-zh-cn @EAT-1004
Feature: Add custom text to email user register notification header / footer and check email receive correctly（SimplifiedChinese)
  As a merchant
  ...
  @EAT-1004-3
  Scenario: Custom Text and Simplified Chinese Support in user register notification email Header and Footer
    ...
    When I input 'user register notification email header 简体 test' to html text field
    ...
    Then I should be redirected to Custom Sign Up Notification Page
    Then 1st html text field should contain 'user register notification email header 简体 test'
    Then 1st html text field should contain 'color background color shop link'
    Then header text count should contain '81/1000'

    When I click on footer edit button
    Then I should see 2 editor toolbar
    Then I should see 2 html text field
    When I input 'user register notification email footer 简体 test' to 2nd html text field
    ...
    Then 2nd html text field should contain 'user register notification email footer 简体 test'
    ...
    When I click on row of mail list included '欢迎加入'
    Then I should see mail detail
    Then mail detail should contain 'user register notification email header 简体 test'
    Then mail detail should contain 'bold italic underline Font Size'
    Then mail detail should contain 'user register notification email footer 简体 test'
