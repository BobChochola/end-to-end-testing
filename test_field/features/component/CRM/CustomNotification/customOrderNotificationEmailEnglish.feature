@BaseCase @Admin @Storefront @CRM @CustomNotification @customOrderNotificationEmailEnglish
@fixture-shop @fixture-product @fixture-delivery @fixture-payment @EAT-1001
Feature: Add custom text to email order notification header / footer and check email receive correctly（English）
  As a merchant
  ...
  @EAT-1001-1
  Scenario: Custom Text and English Support in Order notification email Header and Footer
    ...
    When I input 'Order notification email header test' to 1st html text field
    ...
    Then 1st html text field should contain 'Order notification email header test'
    Then 1st html text field should contain 'bold italic underline Font Size'
    Then header text count should contain '68/1000'

    When I click on footer edit button
    Then I should see 2 editor toolbar
    Then I should see 2 html text field
    When I input 'Order notification email footer test' to 2nd html text field
    ...
    Then I should be redirected to Custom Order Notification Page
    Then 2nd html text field should contain 'Order notification email footer test'
    Then 2nd html text field should contain 'color background color shop link'
    Then footer text count should contain '70/1000'
    ...
    Then mail detail should contain 'Order notification email header test'
    Then mail detail should contain 'bold italic underline Font Size'
    Then mail detail should contain 'Order notification email footer test'
    ...
    And I select status dropdown option included 'Cancelled' of status item dropdown
    ...
    And I wait for 3 seconds for loading
    Then I should see row of mail list
    When I click on row of mail list included 'Order status is updated to: Cancelled'
    Then I should see mail detail
    Then mail detail should contain 'Order notification email header test'
    Then mail detail should contain 'bold italic underline Font Size'
    Then mail detail should contain 'Order notification email footer test'
