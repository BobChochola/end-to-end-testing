@BaseCase @Admin @Storefront @CRM @CustomNotification @customPasswordResetNotificationEmailSimplifiedChinese
@fixture-shop @fixture-multi-lang-zh-cn @EAT-1005
Feature: Add custom text to email password reset notification header / footer and check email receive correctly（Simplified Chinese)
  As a merchant
  ...
  Background:
    ...
    When I select language dropdown option included '简体中文' of language dropdown
  ...
  @EAT-1005-3
  Scenario: Custom Text and Simplified Chinese in password reset notification email Header and Footer
    ...
    When I input 'password reset notification email header 简体 test' to 1st html text field
    ...
    Then I should be redirected to Custom Password Reset Notification Page
    Then 1st html text field should contain 'password reset notification email header 简体 test'
    Then 1st html text field should contain 'color background color shop link'
    Then header text count should contain '82/1000'

    When I click on footer edit button
    Then I should see 2 editor toolbar
    Then I should see 2 html text field
    When I input 'password reset notification email footer 简体 test' to 2nd html text field
    ...
    Then 2nd html text field should contain 'password reset notification email footer 简体 test'
    Then 2nd html text field should contain 'bold italic underline Font Size'
    Then footer text count should contain '80/1000'
    ...
    When I click on row of mail list included '密码重置请求'
    Then I should see mail detail
    Then mail detail should contain 'password reset notification email header 简体 test'
    Then mail detail should contain 'bold italic underline Font Size'
    Then mail detail should contain 'password reset notification email footer 简体 test'
