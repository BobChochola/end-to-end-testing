@BaseCase @Admin @Storefront @CRM @CustomNotification @customUserRegisterNotificationSMSSimplifiedChinese
@fixture-shop @fixture-mobile-signup-p2 @fixture-multi-lang-zh-cn @EAT-1018
Feature: Turn on sms user register notification toggle and check sms receive correctly（Simplified Chinese)
  As a merchant
  ...
  Scenario: User register send sms
    ...
    And I select sign up selection dropdown option included "手机" of sign up selection dropdown
    ...
    And I click on search button
    Then I should see row of mail content
    Then 1st row of mail content should contain sms zh-cn signup notification
