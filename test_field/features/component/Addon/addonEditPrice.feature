@BaseCase @Storefront @Admin @Addon @addonEditPrice @fixture-product
Feature: Edit addon item price
  As a merchant
  ...
  @C3755-3 @fixture-shop
  Scenario: Edit addon item price
    ...
    Then I should see addon price field
    And I fill "30" to addon price field
    ...
    Then addon item should contain "30"
    And ---ROLL BACK---
