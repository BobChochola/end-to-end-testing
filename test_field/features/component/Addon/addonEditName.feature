@BaseCase @Storefront @Admin @Addon @addonEditName @fixture-product
Feature: Edit Add-on items name
  As a merchant
  ...
  @C3755-2 @fixture-shop
  Scenario: Edit addon item name
    ...
    When I click on 1st edit button of addon list
    Then I should be redirected to Addon Edit Page
    And I fill "(dirty data) Add-on Item Edited" to english name field
    And I click on update button
    Then I should be redirected to Addon Index Page
    Then I should see alert
    Then 1st row of addon list should contain "Add-on Item Edited"
    Given I am on Shop Product Index Page
    When I input "1st Product for Checkout" to search field
    Then 1st product of products list should contain "1st Product for Checkout"
    When I click on 1st product of products list
    Then I should be redirected to Shop Product Show Page
    Then addon item should contain "Add-on Item Edited"
    And ---ROLL BACK---
    Given I am on Addon Index Page
    When I click select checkbox of addon list for the same order of row of addon list included 'Add-on Item Edited'
    When I select delete of bulk actions dropdown
    And I should see confirmation popover
    And I click on delete checkbox
    And I click on confirm delete button
    Then addon list should not contain 'Add-on Item Edited'