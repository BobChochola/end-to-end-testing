@BaseCase @Storefront @Admin @Addon @addonUnpublish @fixture-product
Feature: Unpublish addon item
  As a merchant
  ...
  @C3755-6 @fixture-shop
  Scenario: Unpublish addon item
    Given I am on Addon Create Page
    And I fill "(dirty data) test Add-on unpublish" to english name field
    ...
    Then addon item should contain "test Add-on unpublish"
    And ---ROLL BACK---
    Given I am on Addon Index Page
    When I click select checkbox of addon list for the same order of row of addon list included 'test Add-on unpublish'
    When I select delete of bulk actions dropdown
    And I should see confirmation popover
    And I click on delete checkbox
    And I click on confirm delete button
    Then addon list should not contain 'test Add-on unpublish'