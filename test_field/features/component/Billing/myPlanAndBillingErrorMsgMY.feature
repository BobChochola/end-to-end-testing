# @BaseCase @Admin @Billing @myPlanAndBillingErrorMsgMY @baseLocation-MY @EAT-791
# Feature: Admin Billing - Check error msg when using wrong payment in MY shop
#   As a merchant
#   I want to choose a plan and checkout by using wrong payment information in MY shop
...
#   @EAT-791-2
#   Scenario: choose basic plan and checkout by using wrong payment information in MY shop
