...
# @PostTest @PreTest @BaseCase @Admin @Billing @myPlanAndBillingHK @baseLocation-HK
# Feature: Admin Billing - Check error msg when using wrong payment in HK shop
#   As a merchant
#   I want to choose a plan and checkout by using wrong payment information in HK shop
...
#   @C3788
#   Scenario: choose basic plan and checkout by using wrong payment information in HK shop
...
#     Then plan list should contain 'e-Commerce Starter'
#     Then plan list should contain 'e-Commerce Pro'
#     Then plan list should contain 'All-In-One O2O Retailers'
#     Then plan list should contain 'Enterprise'
#     Then plan list should contain 'HK$'
