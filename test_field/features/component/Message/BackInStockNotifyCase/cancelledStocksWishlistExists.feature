@BaseCase @BackInStockNotifyCase @cancelledStocksWishlistExists @fixture-product @theme-kingsman @fixture-shop
Feature: The item is already in the tracking list unsubscribe to notify me will not be removed from the list
  As a merchant
  when product exist wishlist , cancelled notify when in stock button subscribe ,wishlist still exist
  ...
  @EAT-785
  Scenario: The item is already in the tracking list unsubscribe to notify me will not be removed from the list
    ...
    Then 1st row of wishlist should not contain "In Stock Notification On"
