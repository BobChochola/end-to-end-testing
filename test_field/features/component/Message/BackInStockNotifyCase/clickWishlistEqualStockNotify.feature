@BaseCase @BackInStockNotifyCase @Admin @Storefront @clickWishlistEqualStockNotify @fixture-product @theme-kingsman @fixture-shop
Feature: Add wishlist equal subscribe stock on notify
  As a merchant
  I click add wishlist equal subscribe stock on notify
  ...
  @EAT-781
  Scenario: Add wishlist equal subscribe stock on notify
