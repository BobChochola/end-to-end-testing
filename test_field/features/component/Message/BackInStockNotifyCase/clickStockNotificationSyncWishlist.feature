@BaseCase @BackInStockNotifyCase @Admin @Storefront @clickStockNotificationSyncWishlist @fixture-product @theme-kingsman @fixture-shop
Feature: Subscribe to me to notify me equal join tracking list
  As a merchant
  I click on notify when in stock button sync wishlist
  ...
  @EAT-782
  Scenario: Subscribe to me to notify me equal join tracking list
