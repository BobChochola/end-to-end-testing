@BaseCase @ImageService @Admin @Storefront @Checkout @Message @ShopMessage @checkCustomerAndStaffCanReceiveShopMessages
@fixture-payment @fixture-delivery @fixture-product @fixture-shop @fixture-non-basket
Feature: customer/staff can receive shop message sent from each other on message center
  As a staff
  ...
  @EAT-1177 @EAT-1177-3
  Scenario: customer/staff can receive shop message sent from each other on message center
    ...
    Then recipient message content should contain 'staff reply test'
    Then I should have image message photo for image content
