@BaseCase @ImageService @Admin @Storefront @Checkout @Message @OrderMessage @checkCustomerAndStaffCanReceiveOrderMessages
@fixture-payment @fixture-delivery @fixture-product @fixture-shop @fixture-non-basket
Feature: customer/staff can receive order message sent from each other on message center
  As a staff
  ...
  Background:
    ...
    And I click on message checkbox included "Send Message"
  ...
  @EAT-1177 @EAT-1177-1
  Scenario: customer/staff can receive order message sent from each other on message center
    ...
    When I fill 'staff reply test' to message field
    When I pick message photo to image selector
    And I should see delete image button
    And I click on send button
    Then latest message content should contain 'staff reply test'
    ...
    Then mail detail should contain 'staff reply test'
    ...
    Then message recipient content should contain 'staff reply test'
