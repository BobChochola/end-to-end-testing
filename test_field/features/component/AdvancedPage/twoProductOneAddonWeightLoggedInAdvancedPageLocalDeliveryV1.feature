@BaseCase @Admin @Storefront @Product @Checkout @AdvancedPage @twoProductOneAddonWeightLoggedInAdvancedPageLocalDeliveryV1
@fixture-payment @fixture-delivery @fixture-product @fixture-addon @fixture-shop @EAT-817
Feature: Variant product and addon checkout with login from advanced page (localdelivery) V1
  As a merchant
  ...
  Scenario: I want to buy products with different weight and pay correct shipping fee
    ...
    Then 2nd sale price of product list should contain 'NT$10 ~ NT$30'
    ...
    Then total should contain 'NT$85'
    ...
    Then total price should contain "NT$85"
    Then order summary should contain 'Item Subtotal:NT$50'
    Then order summary should contain 'Delivery Fee:NT$35'
    Then order summary should contain 'Total:NT$85'
