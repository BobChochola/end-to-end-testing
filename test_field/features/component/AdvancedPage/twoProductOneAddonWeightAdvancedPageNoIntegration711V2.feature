@BaseCase @Admin @Storefront @Product @Checkout @AdvancedPage @twoProductOneAddonWeightAdvancedPageNoIntegration711V2
@fixture-payment @fixture-delivery @fixture-product @fixture-addon @theme-kingsman @fixture-shop @EAT-927 @smokeTest
Feature: Variant product and addon checkout without login from advanced page (No Integration 711) V2
  As a merchant
  ...
  Scenario: I want to buy products with different weight and pay correct shipping fee
    ...
    Then 1st product should contain 'No variant with weight member price'
    Then 1st regular price of product list should contain 'NT$50'
    Then 2nd product should contain '2 variant with weight'
    ...
    When I fill '6' to popover variation quantity field
    And I click on popover add to cart button
    Then I should see cart panel
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    Then 1st row of unit price should contain "NT$50"
    Then 1st row of subtotal price should contain "NT$50"
    ...
    Then 2nd row of subtotal price should contain "NT$240"
    Then 2nd item quantity field should contain '6'
    ...
    Then cart item subtotal should contain 'NT$300'
    Then delivery fee should contain 'NT$15'
    Then total should contain 'NT$315'
    ...
    Then 1st cart item price should contain 'NT$50'
    Then 1st cart item quantity should contain '1'
    Then 1st cart item subtotal should contain 'NT$50'
    Then 2nd row of product items should contain "2 variant with weight"
    Then 2nd cart item price should contain 'NT$40'
    Then 2nd cart item quantity should contain '6'
    Then 2nd cart item subtotal should contain 'NT$240'
    ...
    Then total price should contain "NT$315"
    Then order summary should contain 'Item Subtotal:NT$300'
    Then order summary should contain 'Delivery Fee:NT$15'
    Then order summary should contain 'Total:NT$315'
    ...
    Then 1st row of product subtotal should contain "NT$50"
    Then 1st row of product quantity should equal to "1"
    Then 1st row of product items should contain "No variant with weight member price"
    Then 2nd row of product unit price should contain "NT$40"
    Then 2nd row of product subtotal should contain "NT$240"
    Then 2nd row of product quantity should equal to "6"
    Then 2nd row of product items should contain "2 variant with weight"
    ...
    Then product details should contain '6 x NT$40 = NT$240'
