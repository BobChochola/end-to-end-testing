@BaseCase @Admin @Storefront @Product @Checkout @AdvancedPage @oneProductWithWeightAdvancedPageNoIntegration711V1
@fixture-payment @fixture-delivery @fixture-product @fixture-shop @EAT-817
Feature: Variant product checkout without login from advanced page (711) V1
  As a merchant
