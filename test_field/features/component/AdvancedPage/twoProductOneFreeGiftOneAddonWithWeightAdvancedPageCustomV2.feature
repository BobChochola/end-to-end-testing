@BaseCase @Admin @Storefront @Product @Checkout @AdvancedPage @twoProductOneFreeGiftOneAddonWithWeightAdvancedPageCustomV2
@fixture-payment @fixture-delivery @fixture-product @fixture-addon @theme-kingsman @fixture-shop @fixture-freegift @fixture-promotion @EAT-927
Feature: Variant product and free gift and addon checkout without login from advanced page (custom) V2
  As a merchant
