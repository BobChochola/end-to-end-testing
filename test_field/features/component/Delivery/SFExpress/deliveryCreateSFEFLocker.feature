@BaseCase @Admin @Delivery @SFExpress @deliveryCreateSFEFLocker
@baseLocation-HK @premiumFeature
Feature: SF with EF Locker pickup Delivery Create Feature
  As a merchant
  I want to create new SF with EF Locker pickup delivery
  ...
  @C3785 @C3785-6
  Scenario: Create Delivery - SF with EF Locker pickup
    ...
    And I fill '(dirty data)S.F. Express - EF Locker Pickup' to name field
    ...
    Then table should not contain '(dirty data)S.F. Express - EF Locker Pickup'