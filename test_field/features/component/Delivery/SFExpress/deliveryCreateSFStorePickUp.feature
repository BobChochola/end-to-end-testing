@BaseCase @Admin @Delivery @SFExpress @deliveryCreateSFStorePickUp
@baseLocation-HK @premiumFeature
Feature: SF with store pickup Delivery Create Feature
  As a merchant
  I want to create new SF with store pickup delivery
  ...
  @C3785 @C3785-4
  Scenario: Create Delivery - SF with store pickup
