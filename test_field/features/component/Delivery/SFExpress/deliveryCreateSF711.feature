@BaseCase @Admin @Delivery @SFExpress @deliveryCreateSF711
@baseLocation-HK @premiumFeature
Feature: SF with 7-11 pickup Delivery Create Feature
  As a merchant
  I want to create new SF with 7-11 pickup delivery
  ...
  @C3785 @C3785-3
  Scenario: Create Delivery - SF with 7-11 pickup
    ...
    Then table should not contain "(dirty data)S.F. Express - 7-11 Store Pickup"