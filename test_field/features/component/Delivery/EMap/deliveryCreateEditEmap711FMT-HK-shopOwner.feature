@BaseCase @Admin @Delivery @EMap @deliveryCreateEditEmap711FMT-HK-shopOwner @fixture-delivery-with-emap
Feature: 711/FMT non-integrated delivery: add 2 new delivery options
  ...
  @EAT-1010 @EAT-1010-2 @baseLocation-HK
  Scenario: 711/FMT non-integrated delivery: add 2 new delivery options-HK
