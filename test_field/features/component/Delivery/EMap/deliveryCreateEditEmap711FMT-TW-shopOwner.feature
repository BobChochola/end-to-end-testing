@BaseCase @Admin @Delivery @EMap @deliveryCreateEditEmap711FMT-TW-shopOwner @fixture-delivery-with-emap
Feature: 711/FMT non-integrated delivery: add 2 new delivery options
  ...
  @EAT-1010 @EAT-1010-1
  Scenario: 711/FMT non-integrated delivery: add 2 new delivery options-TW
    ...
    When I select delivery type dropdown option included '超商取貨' of delivery type dropdown
    ...
    And I click on popover ok button
    And I fill "(dirty data) 全家超商取貨 (純地圖)" to name field
    And I fill the description to description field
    When I fill Delivery Fee to delivery fee field
    And I click on add button
    And I click on confirm adding button
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then table should not contain "(dirty data) New Delete Me"