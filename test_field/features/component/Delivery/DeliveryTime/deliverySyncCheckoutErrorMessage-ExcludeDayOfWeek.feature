@BaseCase @Admin @Storefront @Delivery @DeliveryTime @deliverySyncCheckoutErrorMessage-ExcludeDayOfWeek @fixture-product @fixture-shop @fixture-payment @fixture-delivery
Feature: delivery setting lead time sync with dispaly error message in checkout page
  As a Shopline
  ...
  @EAT-1202 @EAT-1202-4
  Scenario: delivery setting lead time sync with dispaly error message in checkout page
    Given I am on Delivery Create Page
    When I select delivery type dropdown option included 'Custom' of delivery type dropdown
    And I fill "(dirty data) DeliveryExcludeDayOfWeek" to name field
    ...
    And I select delivery dropdown option included "(dirty data) DeliveryExcludeDayOfWeek" of delivery method dropdown
    And I wait for 3 seconds for loading
    ...
    And I click on 1st this month enabled date picker
    ...
    And I select exclude specific day dropdown option included 'Monday' of exclude specific day dropdown
    And I click on exclude specific day dropdown option included 'Tuesday'
    And I click on exclude specific day dropdown option included 'Wednesday'
    And I click on exclude specific day dropdown option included 'Thursday'
    And I click on exclude specific day dropdown option included 'Friday'
    And I click on exclude specific day dropdown option included 'Saturday'
    ...
    Then table should not contain "(dirty data) DeliveryExcludeDayOfWeek"