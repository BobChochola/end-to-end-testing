@BaseCase @Admin @Storefront @Delivery @DeliveryTime @deliveryTimeToggleSyncCheckoutErrorMessage-LeadTime @fixture-product @fixture-shop @fixture-payment @fixture-delivery
Feature: delivery setting lead time sync with display error message in checkout page
  As a Shopline
  ...
  @EAT-1202 @EAT-1202-2
  Scenario: delivery setting lead time sync with display error message in checkout page
    ...
    And I fill '4' to lead time field
    ...
    Then I click on 2nd this month enabled date picker
    ...
    And I fill '6' to lead time field
