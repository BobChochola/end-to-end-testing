@PostTest @PreTest @BaseCase @Admin @Delivery @Zeek2door @deliveryCreateZeek2door
@baseLocation-HK @premiumFeature
Feature: HK Zeek2door Delivery Create Feature
  As a merchant
  I want to create new HK delivery
  ...
  @C3785 @C3785-1
  Scenario: Create Delivery - Zeek2door
    ...
    And I fill 'test account' to zeek2door account field
