@BaseCase @Admin @Storefront @Delivery @deliveryCreateEditDrag711C2C-inspector
@fixture-payment @fixture-product @fixture-shop
Feature: Create Delivery 7-11 C2C via inspector
  As a merchant
  ...
  @EAT-1039-14 @EAT-1039-14-1
  Scenario: Create Delivery via inspector - 7-11 Pickup and pay in store (C2C)
    ...
    Then 3rd field error message should contain 'Not allow spaces and symbols, or more than 5 characters.'
    When I fill "(dirty data) 7-11 Pickup and pay in store (C2C)" to name field
    ...
    And I fill the Merchant Name to sender chinese name field
    And I fill the Phone Number to phone number field
    ...
    And 1st row of delivery options list should contain "7-11 Pickup and pay in store (C2C)"
    ...
    When I fill "(dirty data) 7-11 Pickup and pay in store (C2C) edited" to name field
    When I fill '999' to parent id field
    When I fill '999' to shop id field
    When I fill 'test' to sender chinese name field
    When I fill '0912345678' to phone number field
    ...
    Then I should be redirected to Delivery Edit Page
    When I click on language tab included 'English'
    Then delivery execution mode dropdown option should contain 'Auto'
    Then name field should equal to "(dirty data) 7-11 Pickup and pay in store (C2C) edited"
    Then parent id field should equal to '999' 
    Then shop id field should equal to '999'
    Then merchant name field should equal to 'test'
    Then sender chinese name field should equal to 'test'
    Then phone number field should equal to '0912345678'
    ...
    Then table should not contain '7-11 Pickup and pay in store (C2C) edited'

  @EAT-1039-14 @EAT-1039-14-2
  Scenario: Create Delivery via inspector - 7-11 Pickup only (C2C)
    Given I am on Delivery Create Page
    When I select delivery type dropdown option included 'Pick-up' of delivery type dropdown
    Then shipping from edit button should contain 'Taiwan'
    Then shipping to edit button should contain 'Taiwan'
    ...
    And I click on popover ok button
    When I fill "(dirty data) 7-11 Pickup only (C2C)" to name field
    And I fill the Parent ID to parent id field
    And I fill the Shop ID to shop id field
    And I fill the Merchant Name to merchant name field
    And I fill the Merchant Name to sender chinese name field
    ...
    And I click on confirm adding button
    Then I should be on Delivery Options Page
    And 1st row of delivery options list should contain "7-11 Pickup only (C2C)"
    And I drag 2nd drag icon of delivery method list to 1st drag icon of delivery method list
    Then I should be redirected to Unauthorized Page
    Given I am on Delivery Options Page
    When I click on 1st edit button of delivery method list
    ...
    When I click on language tab included 'English'
    When I select delivery execution mode dropdown option included 'Auto' of delivery execution mode dropdown
    When I fill "(dirty data) 7-11 Pickup only (C2C) edited" to name field
    When I fill '999' to parent id field
    When I fill '999' to shop id field
    When I fill 'test' to sender chinese name field
    When I fill '0912345678' to phone number field
    ...
    When I click on language tab included 'English'
    Then delivery execution mode dropdown option should contain 'Auto'
    Then name field should equal to "(dirty data) 7-11 Pickup only (C2C) edited"
    Then parent id field should equal to '999' 
    Then shop id field should equal to '999'
    Then merchant name field should equal to 'test'
    Then sender chinese name field should equal to 'test'
    ...
    When I click on delete checkbox
    When I click on confirm delete button
    Then table should not contain '7-11 Pickup only (C2C) edited'
