@BaseCase @Admin @Storefront @Delivery @711 @deliveryCreateEditDrag711B2C-superAdmin
@premiumFeature @fixture-payment @fixture-product @fixture-shop
Feature: Create Delivery 7-11 B2C via super admin
  As a merchant
  ...
  @C2101 @C2101-9 @C3732-3 @EAT-978 @EAT-978-4 @EAT-1039-1 @EAT-1039-1-1 @smokeTest
  Scenario: Create Delivery via super admin and check action logs - 7-11 Pickup and pay in store (B2C)
    ...
    And 2nd row of delivery options list should contain "7-11 Pickup and pay in store (B2C)"
    ...
    Then 2nd delivery dropdown option should contain '7-11 Pickup and pay in store (B2C) edited'
    When I switch to 1 of tabs
    Then I should be redirected to Delivery Options Page
    When I click on 2nd publish button of delivery method list
    Then 2nd row of delivery options list should contain 'Publish'
    When I switch to 2 of tabs
    Then I should be redirected to Shop Cart Page
    When I Refresh
    Then 2nd delivery dropdown option should not contain '7-11 Pickup and pay in store (B2C) edited'
    When I switch to 1 of tabs
    Then I should be redirected to Delivery Options Page
    Then 2nd row of delivery options list should contain '7-11 Pickup and pay in store (B2C) edited'
    When I click on 2nd edit button of delivery method list
    Then I should be redirected to Delivery Edit Page
    When I click on language tab included 'English'
    ...
    Then id should contain "7-11 Pickup and pay in store (B2C)"
    Then id should contain "7-11 取貨付款 (B2C)"
    Then id should contain "region_type\":[null,\"tw_711_b2c_pay\"]"
    When I switch to 2 of tabs
    And ---ROLL BACK---
  ...
  @C2101 @C2101-10 @EAT-1039-1 @EAT-1039-1-2
  Scenario: Create Delivery via super admin - 7-11 Pickup only (B2C)
    ...
    And I drag 2nd drag icon of delivery method list to 1st drag icon of delivery method list
    And 2nd row of delivery options list should contain "7-11 Pickup only (B2C)"
    When I click on 2nd edit button of delivery method list
    Then I should be redirected to Delivery Edit Page
    Then delivery type dropdown should be disabled
    When I click on language tab included 'English'
    ...
    When I select country dropdown option included "Taiwan" of country list dropdown
    Then I wait for 3 seconds for loading
    Then 2nd delivery dropdown option should contain '7-11 Pickup only (B2C) edited'
    When I switch to 1 of tabs
    Then I should be redirected to Delivery Options Page
    When I click on 2nd publish button of delivery method list
    Then 2nd row of delivery options list should contain 'Publish'
    ...
    Then I should be redirected to Shop Cart Page
    When I Refresh
    Then 2nd delivery dropdown option should not contain '7-11 Pickup only (B2C) edited'
    When I switch to 1 of tabs
    Then I should be redirected to Delivery Options Page
    Then 2nd row of delivery options list should contain '7-11 Pickup only (B2C) edited'
    When I click on 2nd edit button of delivery method list
    Then I should be redirected to Delivery Edit Page
    When I click on language tab included 'English'
    When delivery execution mode dropdown option should contain 'Auto'
