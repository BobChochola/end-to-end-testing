@PostTest @PreTest @BaseCase @Admin @Delivery @711 @deliveryAssertHK711-inspector
Feature: HK Delivery should not contain 711(inspector)
  As a merchant
  ...
  @EAT-1039-6 @baseLocation-HK
  Scenario: HK Delivery should not contain 711(inspector)
