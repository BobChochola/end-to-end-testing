@PostTest @PreTest @BaseCase @Admin @Delivery @711 @deliveryAssertHK711-superAdmin
Feature: HK Delivery should not contain 711(super admin)
  As a merchant
  ...
  @EAT-1039-5 @baseLocation-HK @premiumFeature
  Scenario: HK Delivery should not contain 711(super admin)
