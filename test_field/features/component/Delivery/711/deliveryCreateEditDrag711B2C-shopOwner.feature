@PostTest @PreTest @BaseCase @Admin @Storefront @Delivery @711 @deliveryCreateEditDrag711B2C-shopOwner
@fixture-delivery @fixture-payment @fixture-product @fixture-shop
Feature: Create Delivery 7-11 B2C via shop owner
  ...
  @C3889-1 @EAT-1039-3 @EAT-1039-3-1
  Scenario: Create Delivery via shop owner - 7-11 Pickup and pay in store (B2C)
  ...
  @C3889-2 @EAT-1039-3 @EAT-1039-3-2
  Scenario: Create Delivery via shop owner - 7-11 Pickup only (B2C)
    Given I am on Delivery Create Page
    When I select delivery type dropdown option included 'Pick-up' of delivery type dropdown
    Then shipping from edit button should contain 'Taiwan'
    Then shipping to edit button should contain 'Taiwan'
