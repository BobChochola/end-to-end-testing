@PostTest @PreTest @BaseCase @Admin @Storefront @Delivery @711 @deliveryCreateEditDrag711C2C-superAdmin
@premiumFeature @fixture-payment @fixture-product @fixture-shop
Feature: Third Party Delivery Create Feature
  ...
  @C2101 @C2101-7 @EAT-1039-13 @EAT-1039-13-1
  Scenario: Create Delivery - 7-11 Pickup and pay in store (C2C)
    ...
    And 2nd row of delivery options list should contain "7-11 Pickup and pay in store (C2C)"
    ...
    Then 2nd delivery dropdown option should contain '7-11 Pickup and pay in store (C2C) edited'
    When I switch to 1 of tabs
    Then I should be redirected to Delivery Options Page
    Then 2nd row of delivery options list should contain '7-11 Pickup and pay in store (C2C) edited'
    When I click on 2nd edit button of delivery method list
    Then I should be redirected to Delivery Edit Page
    When I click on language tab included 'English'
  ...
  @C2101 @C2101-8 @EAT-1039-13 @EAT-1039-13-2
  Scenario: Create Delivery - 7-11 Pickup only (C2C)
    Given I am on Delivery Create Page
    When I select delivery type dropdown option included 'Pick-up' of delivery type dropdown
    Then shipping from edit button should contain 'Taiwan'
    Then shipping to edit button should contain 'Taiwan'
    ...
    And I drag 2nd drag icon of delivery method list to 1st drag icon of delivery method list
    And 2nd row of delivery options list should contain "7-11 Pickup only (C2C)"
    When I click on 2nd edit button of delivery method list
    Then I should be redirected to Delivery Edit Page
    Then delivery type dropdown should be disabled
    When I click on language tab included 'English'
    ...
    When I select country dropdown option included "Taiwan" of country list dropdown
    Then I wait for 3 seconds for loading
    Then 2nd delivery dropdown option should contain '7-11 Pickup only (C2C) edited'
    When I switch to 1 of tabs
    Then I should be redirected to Delivery Options Page
    Then 2nd row of delivery options list should contain '7-11 Pickup only (C2C) edited'
    When I click on 2nd edit button of delivery method list
    Then I should be redirected to Delivery Edit Page
    When I click on language tab included 'English'
    Then delivery execution mode dropdown option should contain 'Auto'
