@BaseCase @Storefront @Admin @addRemoveUpdateProductQuantityOnShop @fixture-shop @fixture-product @fixture-freegift @fixture-payment @fixture-delivery @fixture-promotion @EAT-1041
Feature: Check Product add/remove/update product qantity on product-detail-page/cart-page/cart-in-sidebar/express-checkout-page/quick-add-to-cart
  As a shopper
  I can add/remove/update product qantity on shop 
  ...
  @EAT-1041-1
  Scenario: Increase/decrease/update/remove product/addon/freegift quantity on product-detail-page/cart-page/cart-in-sidebar/express-checkout-page/quick-add-to-cart
    ...
    Then I should see 1 cart item list
    And cart item list should contain '17th Product for Checkout'
    ...
    And 1st cart item list should contain '4x NT$10'
    And 2nd cart item list should contain '3rd Addon for Checkout'
    And 2nd cart item list should contain '2x NT$10'
    When I click on close cart panel area
    ...
    And applied promotion should contain '18th Free Gift Promotion'
    When I click on row of applied promotion included '18th Free Gift Promotion'
    Then I should be redirected to Shop Promotion Page
  ...
  @EAT-1041-2
  Scenario: Increase/decrease/update/remove product/addon/freegift quantity on Express-checkout-page
