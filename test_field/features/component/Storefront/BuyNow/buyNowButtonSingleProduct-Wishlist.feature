@BaseCase @Admin @Storefront @Design @BuyNow @buyNowButtonSingleProduct-Wishlist
@fixture-product @fixture-delivery @fixture-payment @fixture-shop @theme-ultra-chic
Feature: Buy now button add single product in wishlist page
  As a Shopline
  when I turn on buy now button rollout key
  I can buy now in wishlist page
  ...
  @EAT-1197 @EAT-1197-1
  Scenario: Buy now button add single product in wishlist page 
    ...
    Then row of cart item should contain '13th Product for Checkout'
    Then row of cart item should not contain '18th Product for Checkout'
    Then row of cart item should not contain 'Out Of Stock'
