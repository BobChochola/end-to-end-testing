@BaseCase @Admin @Storefront @switchCurrencyTWD @fixture-product @fixture-shop
Feature: Switch Currency
  ...
  @C3797 @C3797-3
  Scenario: Switch currency to TWD
    Given I am on Shop Product Index Page
    When I input "1st Product for Checkout" to search field
    Then 1st product of products list should contain '1st Product for Checkout'
    And I click on currency dropdown included "$"
    And I click on currency included "TWD"
    Then 1st product of products list should contain "NT"
    ...
    And order summary should contain "NT"
    When I click on proceed to checkout button
    Then I should be redirected to Shop Checkout Page
    When I click on cart summary
    Then order summary should contain "NT"
    And ---ROLL BACK---
    Given I am on Shop Product Index Page
