@OneBaseCase @OneQuickTest @ImageService @Admin @Product @oneModifyVariantOption @fixture-sl-pos @fixture-sl-pos-admin @fixture-integration-one
Feature: after edit variant option, check sync One is correct
  As a merchant
  product edit variation can sync One is correct
  ...
  @EAT-962 @EAT-962-1
  Scenario: edit 2 layer, 2 option product to 1 layer, 2 option and check One UI (limited)
    Given I am on Product Create Page
    When I pick product photo to product photo selector
    Then I should see delete photo button
    And I click on info tab
    And I fill "(dirty data) edit 1layer 2option product" to english name field
    And I fill "edit 1layer 2option product" to chinese name field
    ...
    Then popup title should contain "edit 1layer 2option product"
    ...
    Then 1st row of product list should contain "edit 1layer 2option product"
    ...
    Then product list should contain "edit 1layer 2option product"
    ...
    Then 1st product name should contain "edit 1layer 2option product"
    Then 2nd product name should contain "edit 1layer 2option product"
    Then 3th product name should contain "edit 1layer 2option product"
    Then 4rd product name should contain "edit 1layer 2option product"
    ...
    And I click on 2nd variation remove button
    Then I should see remove popup
    And I click on ok button
    Then I should see 1 variation remove button
    Then remove row of variation tags should not contain "M"
    Then remove row of variation tags should not contain "L"
    And I fill "50" to 1st row of variation price field
    And I fill "50" to 2nd row of variation price field 
    And I fill "10" to 1st row of variation member price field
    And I fill "10" to 2nd row of variation member price field
    ...
    Given I am on One Product Index Page
    Then product list should contain "edit 1layer 2option product"
    Then variants quantity should equal to "2"
    Then stock quantity should contain "30"
    Then pend to deliver quantity should equal to "0"
    Then available quantity should contain "30"
    Then I click on manage button
    ...
    Then product list should not contain "edit 1layer 2option product"

  @EAT-962 @EAT-962-2
  Scenario: edit 2 layer, 2 option product to 1 layer, 2 option and check One UI (unlimited)
    Given I am on Product Create Page
    When I pick product photo to product photo selector
    Then I should see delete photo button
    And I click on info tab
    And I fill "edit 1layer 2option product(unlimited)" to english name field
    And I fill "edit 1layer 2option product(unlimited)" to chinese name field
    And I click on variations tab
    And I click on variations toggle
    When I input "R" to 1st add options field
    And I input "G" to 1st add options field
    ...
    And I click on add button
    Then I should be redirected to Product Index Page
    Then popup title should contain "edit 1layer 2option product(unlimited)"
    Then 1st popup panel should contain "Create Purchase Order"
    Then 2nd popup panel should contain "Directly Edit Inventory of Each Warehouse"
    Then 3rd popup panel should contain "Add Another Product"
    And I click on back to my products panel
    Then I should see row of product photo list
    Then I should have image product photo for row of product photo list
    Then 1st row of product list should contain "edit 1layer 2option product(unlimited)"
    Then 1st row of regular price list should contain "NT$50"
    Then 1st row of quantity list should contain "∞"
    Then I wait for 30 seconds for products sync

    Given I am on One Product Index Page
    Then product list should contain "edit 1layer 2option product(unlimited)"
    Then variants quantity should contain "4"
    Then stock quantity should contain "0"
    Then pend to deliver quantity should equal to "0"
    Then available quantity should contain "0"
    Then I click on manage button
    ...
    Then 1st product name should contain "edit 1layer 2option product(unlimited)"
    Then 2nd product name should contain "edit 1layer 2option product(unlimited)"
    Then 3th product name should contain "edit 1layer 2option product(unlimited)"
    Then 4rd product name should contain "edit 1layer 2option product(unlimited)"
    ...
    Then 3rd sales channel available quantity should contain "∞ Untracked"
    Then 4th sales channel available quantity should contain "∞ Untracked"
    ...
    Then 4th inventory warehouse included 'Primary' and same order of inventory stock quantity should also equal to '0'
    Then 4th inventory warehouse included 'Primary' and same order of inventory pend to deliver quantity should also equal to '0'
    Then 4th inventory warehouse included 'Primary' and same order of inventory available quantity should also equal to '0'
    Then 4th inventory row of variant dropdown should equal to 'G, L'
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain "edit 1layer 2option product(unlimited)"

  @EAT-962 @EAT-962-3
  Scenario: edit 1 layer, 1 option product to 2 layer, 2 option and check One UI (limited)
    Given I am on Product Create Page
    When I pick product photo to product photo selector
    Then I should see delete photo button
    And I click on info tab
    And I fill "edit 1layer 1option product" to english name field
    And I fill "edit 1layer 1option product" to chinese name field
    And I click on variations tab
    And I click on variations toggle
    When I input "R" to 1st add options field
    And I click on variations same price checkbox
    ...
    And I click on add button
    Then I should be redirected to Product Index Page
    Then popup title should contain "edit 1layer 1option product"
    Then 1st popup panel should contain "Create Purchase Order"
    Then 2nd popup panel should contain "Directly Edit Inventory of Each Warehouse"
    Then 3rd popup panel should contain "Add Another Product"
    And I click on back to my products panel
    Then I should see row of product photo list
    Then I should have image product photo for row of product photo list
    Then 1st row of product list should contain "edit 1layer 1option product"
    Then 1st row of regular price list should contain "NT$50"
    Then 1st row of quantity list should contain "10"
    Then I wait for 30 seconds for products sync

    Given I am on One Product Index Page
    Then product list should contain "edit 1layer 1option product"
    Then variants quantity should contain "1"
    ...
    Then 1st sales channel should contain shop name
    Then 1st country should contain "Taiwan"
    Then 1st product name should contain "edit 1layer 1option product"
    ...
    Then 1st product name should contain "edit 1layer 1option product"
    Then 2nd product name should contain "edit 1layer 1option product"
    Then 3th product name should contain "edit 1layer 1option product"
    Then 4rd product name should contain "edit 1layer 1option product"
    ...
    And I click on delete checkbox
    And I click on confirm delete button
    Then product list should not contain "edit 1layer 1option product"