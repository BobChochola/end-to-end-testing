@OneBaseCase @Admin @Storefornt @Order @OrderEdit @checkChangeWarehousesAndOrderEditBeforeCheckout @fixture-shop @fixture-product @fixture-delivery @fixture-payment @fixture-warehouse @fixture-sl-pos @fixture-sl-pos-admin @fixture-integration-one
Feature: Checkout product before change warehouse, order edit add same products and check UI
  As a user of Shopline
  I checkout before change warehouse, order edit add new product still correct
  ...
  @EAT-980 @EAT-980-4
  Scenario: Checkout novariation product before change warehouse, order edit add same products and check UI
    ...
    Then 1st product of product list should contain "15th Product for Checkout"
    ...
    Then 1st warehouse label should contain "Primary"
    Then 2nd warehouse label should contain "testQA"
  ...
  @EAT-980 @EAT-980-5
  Scenario: Checkout 1 layer product before change warehouse, order edit add same products and check UI
    Given I am on One Product Index Page
    ...
    Then 2nd inventory warehouse included 'testQA' and same order of inventory stock quantity should also equal to "10"
    ...
    Then I should see product of product list
    Then 1st product of product list should contain "19th Product for Checkout"
    And I click on 1st product of product list
    And I click on popup save button
    And I select color dropdown option included "Blue" of color dropdown
  ...
  @EAT-980 @EAT-980-6
  Scenario: Checkout 2 layer product before change warehouse, order edit add same products and check UI
    Given I am on One Product Index Page
    ...
    Then inventory row of variant dropdown included 'Blue, S' and same order of testqa inventory available quantity should also equal to '0→ 10'
    When I click testqa inventory save button for the same order of inventory row of variant dropdown included 'Blue, S'
    Then inventory row of variant dropdown included 'Blue, S' and same order of testqa inventory available quantity should also equal to '10'
    ...
    And I click on popup save button
    And I select color dropdown option included "Blue" of color dropdown
    And I select color dropdown option included "S" of 2nd color dropdown
    And I click on product details save button
    Then I should see 2 product quantity field
    Then I should see 2 product quantity reminder
    Then I should see confirm popover
