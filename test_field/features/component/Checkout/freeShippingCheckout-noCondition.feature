@BaseCase @Admin @Storefront @Checkout @freeShippingCheckout-noCondition
@fixture-payment @fixture-delivery @fixture-product @fixture-promotion @fixture-shop
Feature: Free Shipping No Condition
  As a customer
  I want to place order with Free Shipping No Condition applied
  ...
  @C3830
  Scenario: I want to place order with Free Shipping No Condition applied
    ...
    Then discount applied should contain "3rd Free Shipping"
