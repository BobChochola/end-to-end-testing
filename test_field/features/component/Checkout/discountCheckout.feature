@PostTest @PreTest @Admin @BaseCase @Storefront @Checkout @CouponCode @discountCheckout @fixture-product @fixture-shop @fixture-promotion @fixture-payment @fixture-delivery @smokeTest
Feature: Get discount on Entire Order with purchase over items
  ...
  Scenario:
    ...
    Then discount applied should contain "-NT$3"
    Then delivery fee should contain "NT$10"
    Then total should contain "NT$37"
