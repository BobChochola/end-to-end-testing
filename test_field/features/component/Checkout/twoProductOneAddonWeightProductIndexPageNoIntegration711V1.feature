@BaseCase @Admin @Storefront @Product @Checkout @twoProductOneAddonWeightProductIndexPageNoIntegration711V1
@fixture-payment @fixture-delivery @fixture-product @fixture-addon @fixture-shop @EAT-817
Feature: Variant product and addon checkout without login from product list page (711 no integration) V1
  As a merchant
  ...
  Scenario: I want to buy products with different weight and pay correct shipping fee
    ...
    Then cart item subtotal should contain 'NT$140'
    ...
    Then 2nd cart item subtotal should contain 'NT$80'
    ...
    Then total price should contain "NT$140"
    Then order summary should contain 'Item Subtotal:NT$140'
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$140'
    ...
    Then 3rd row of product items should contain "Add-on with weight"
    Then item subtotal should contain 'NT$140'
    Then delivery fee should contain 'NT$0'
    Then total should contain 'NT$140'
