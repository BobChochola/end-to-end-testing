@BaseCase @Admin @Storefront @Checkout @mobile-freeShippingCheckout-minItemCoexist
@fixture-mobile-signup-p2 @fixture-shop @fixture-product @fixture-delivery @fixture-payment @fixture-promotion
Feature: Mobile member Checkout - Free Shipping when Total Order Over Minimum items co-exist
  As a customer
