# due to PR-1934
# @BaseCase @Admin @Storefront @Checkout @mobile-unqualifiedStripeCheckout
# @baseLocation-HK @fixture-mobile-signup-p2 @fixture-shop @fixture-product @fixture-delivery @fixture-payment @fixture-promotion
# Feature: Mobile member Checkout - Unqualified Stripe Checkout
#   As a guest
