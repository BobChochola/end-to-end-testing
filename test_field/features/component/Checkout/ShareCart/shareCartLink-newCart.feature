@BaseCase @Admin @Storefront @Checkout @ShareCart @CouponCode @shareCartLink-newCart
@fixture-payment @fixture-delivery @fixture-product @fixture-shop @fixture-promotion @fixture-addon
Feature: Checkout different product with Affiliate campaign - url redirect to new cart
  As a customer
  ...
  Scenario: Checkout different variations with promotion
    ...
    Then I should see cart panel
    And I check and click cart panel remove button
    And I check and click cart panel remove button
    And I check and click cart panel remove button
    And I check and click cart panel remove button
    ...
    Then I should see coupon code field
    And I input "ExceptECPay" to coupon code field
    Then I should see 4 row of cart item
    ...
    And 1st item quantity field should contain '1'
    ...
    And 2nd item quantity field should contain '1'
    And 3th row of cart item should contain '12th Product for Checkout'
    And 3rd item quantity field should contain '1'
    And 4th row of cart item should contain '13th Product for Checkout'
    And 4th item quantity field should contain '1'
    When I click on 1st increase quantity button
    And I wait for 3 seconds for loading
    And 1st item quantity field should contain '2'
    When I click on 3rd increase quantity button
    And I wait for 3 seconds for loading
    And 3rd item quantity field should contain '2'
    When I click on 4th increase quantity button
    And I wait for 3 seconds for loading
    And 4th item quantity field should contain '2'
    Then I scroll down to country dropdown option 
    Then I select country dropdown option included "Taiwan" of country list dropdown
    And I wait for 3 seconds for loading
    Then I select delivery dropdown option included "Custom Delivery" of delivery method dropdown
