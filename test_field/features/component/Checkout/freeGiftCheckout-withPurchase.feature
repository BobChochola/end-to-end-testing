@BaseCase @Admin @Storefront @FreeGift @Checkout @CouponCode @freeGiftCheckout-withPurchase
@fixture-product @fixture-freegift @fixture-shop @fixture-delivery @fixture-payment @fixture-promotion
Feature: Shop Checkout use coupon with three free gifts product
  As a merchant
