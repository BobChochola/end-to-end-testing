@BaseCase @Admin @Storefront @Product @Checkout @oneProductOneAddonWithWeightProductIndexPage711C2CV1
@fixture-payment @fixture-delivery @fixture-product @fixture-addon @fixture-shop @EAT-817
Feature: Variant product and addon checkout without login from product list page (711 C2C) V1
  As a merchant
  ...
  Scenario: I want to buy products with different weight and pay correct shipping fee
    ...
    Then 1st row of unit price should contain "NT$40"
    ...
    Then 1st cart item price should contain 'NT$40'
    ...
    Then delivery fee should contain "NT$0"
    Then total should contain "NT$50"
    Then 1st row of product unit price should contain "NT$40"
