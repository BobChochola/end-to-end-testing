@BaseCase @Admin @Storefront @Checkout @checkNoAlertInputScriptToPromotionDeliveryPaymentTitleV2 @fixture-product @theme-kingsman @fixture-shop
Feature: should not see any alert on storefront(set delivery/payment/promotion/customer) - v2
  As a merchant
  ...
  @EAT-939 @EAT-939-4
  Scenario: should not see any alert on storefront(set delivery/payment/promotion/customer) - v2
    ...
    Then 1st kingsman product of products list should contain "15th Product for Checkout"
