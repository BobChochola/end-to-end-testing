@PostTest @PreTest @Admin @BaseCase @Storefront @Checkout @mobile-autoCreditsCheckoutWithFamilymart
@fixture-mobile-signup-p2 @fixture-shop @fixture-product @fixture-delivery @fixture-payment @fixture-promotion
Feature: Mobile member Checkout - Auto Credits Checkout With Family Mart
  As a merchant
  ...
  Scenario: Assign credits and checkout with family mart
    ...
    When I fill test phone to email field
