@BaseCase @Admin @Storefront @Checkout @freeShippingCheckout-totalOrderMin
...
Feature: Free Shipping when Total Order Over Minimum Amount
  As a customer
  I want to place order with Free Shipping when Total Order over Minimum Amount
  ...
  @C3831
  Scenario: I want to place order with Free Shipping when Total Order over Minimum Amount
