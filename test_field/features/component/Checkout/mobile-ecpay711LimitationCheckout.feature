@Admin @BaseCase @Storefront @Checkout @mobile-ecpay711LimitationCheckout
@fixture-mobile-signup-p2 @fixture-shop @fixture-product @fixture-delivery @fixture-payment @fixture-promotion
Feature: Mobile member Checkout - Fit limitation with Ecpay (711B2C)
  As a customer
  ...
  Scenario: Checkout - Fit limitation with Ecpay
    ...
    Then I should see agree button
