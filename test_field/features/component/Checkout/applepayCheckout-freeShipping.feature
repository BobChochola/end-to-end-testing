@BaseCase @Admin @Storefront @Checkout @applepayCheckout-freeShipping
@fixture-shop @fixture-promotion @fixture-payment @fixture-delivery @baseLocation-HK
Feature: Checkout-Apple Pay (membership with free shipping)-HK
  As a guest
