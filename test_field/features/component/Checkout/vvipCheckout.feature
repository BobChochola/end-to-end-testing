@BaseCase @Admin @Storefront @Checkout @vvipCheckout
@fixture-payment @fixture-delivery @fixture-product @fixture-promotion @fixture-shop
Feature: Checkout with VVVIP tier and check membership on member center
  As a guest
  ...
  @C3848
  Scenario: Checkout with VVVIP tier and check membership on member center
    Given I am on Shop Home Page
    When I click on member center button
    Then I should be redirected to Shop User Profile Page
    Then I should see membership level
    Then membership level should contain 'VVVIP discount'
    Then 1st row of membership detail list should contain 'Membership Expiry Date Never Expire'
