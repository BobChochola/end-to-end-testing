@BaseCase @Admin @Storefront @Product @Checkout @oneProductWithWeightLoggedInProductIndexPageLocalDeliveryV1-extraProduct
@fixture-payment @fixture-delivery @fixture-product @fixture-mobile-signup-p2 @fixture-shop @EAT-817
Feature: Variant product checkout with login from product list page (Local Delivery) V1
  As a merchant
  ...
  Scenario: I want to buy products with different weight and pay correct shipping fee
    ...
    Then 1st regular price of products list should contain 'NT$100'
    Then 1st sale price of products list should contain 'NT$30 ~ NT$60'
    When I click on 1st product of products list
    Then I should be redirected to Shop Product Show Page
    ...
    Then regular price should contain "NT$100"
    Then sale price should contain "NT$60"
    When I click on dropdown option included 'S'
    Then regular price should contain "NT$90"
