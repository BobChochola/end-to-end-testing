@BaseCase @Admin @Storefront @Checkout @Freeshipping @freeShippingCheckoutReminder
@fixture-shop @fixture-delivery @fixture-payment @fixture-product
Feature: Checkout - Shopping Cart Promotion Reminder
  As a customer
  ...
  Background:
    ...
    And I fill '(dirty data) Enjoy free shipping with purchase over NT$200' to name field
    And I click on subtotal condition checkbox
    And I fill '200' to promotion condition field
    ...
    Then promotion name should contain 'Enjoy free shipping with purchase over NT$200'
    ...
    Then discount summary should contain 'Enjoy free shipping with purchase over NT$200'
    When I click on confirm button
    Then I should be redirected to Free Shipping Index Page
    Then I should see alert
    Then 1st row of free shipping list should contain 'Enjoy free shipping with purchase over NT$200'
  ...
  Scenario: Checkout - Shopping Cart Promotion Reminder
    ...
    And unapplied promotion should contain 'Enjoy free shipping with purchase over NT$200'
    Given I am on Shop Product Index Page
    When I input '18th Product for Checkout' to search field
    Then 1st product of products list should contain "18th Product for Checkout"
    When I click on 1st product of products list
    ...
    Then I should see alert
    And row of free shipping list should not contain 'Enjoy free shipping with purchase over NT$200'