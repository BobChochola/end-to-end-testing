@BaseCase @Admin @Storefront @Checkout @freeCheckoutNoIntegration711 @fixture-payment @fixture-delivery @fixture-product @fixture-shop @fixture-promotion
Feature: Checkout - Free Checkout (7-11 no integration)
  As a customer
