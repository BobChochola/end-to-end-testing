@BaseCase @Admin @Storefront @Checkout @taishinTappayCheckout
@fixture-payment @fixture-delivery @fixture-product @fixture-promotion @fixture-shop @premiumFeature
Feature: Taishin Tappay check
