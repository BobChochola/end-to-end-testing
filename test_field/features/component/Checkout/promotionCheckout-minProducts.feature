@BaseCase @Admin @Storefront @Checkout @promotionCheckout-minProducts
@fixture-payment @fixture-delivery @fixture-product @fixture-promotion @fixture-shop
Feature: Free Shipping when Total Order Over Minimum Amount
  As a customer
  I want to place order with Free Shipping when Total products over Minimum Amount
  ...
  @C3828
  Scenario:Selected Products over the minimum items
