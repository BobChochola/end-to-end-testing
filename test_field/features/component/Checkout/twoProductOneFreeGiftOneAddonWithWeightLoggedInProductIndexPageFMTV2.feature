@BaseCase @Admin @Storefront @Product @Checkout @twoProductOneFreeGiftOneAddonWithWeightLoggedInProductIndexPageFMTV2
@fixture-payment @fixture-delivery @fixture-product @fixture-addon @fixture-freegift @fixture-promotion @theme-kingsman @fixture-mobile-signup-p2 @fixture-shop @EAT-927
Feature: Variant product and free gift and addon checkout with login from product list page (FMT) V2
  As a merchant
  ...
  Scenario: I want to buy products with different weight and pay correct shipping fee
    ...
    Then 3rd row of subtotal price should contain "NT$30"
    ...
    Then 3rd cart item subtotal should contain 'NT$30'
    ...
    Then 3rd row of product subtotal should contain "NT$30"
