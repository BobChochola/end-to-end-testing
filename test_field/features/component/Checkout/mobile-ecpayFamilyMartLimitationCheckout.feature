@PostTest @PreTest @Admin @BaseCase @Storefront @Checkout @mobile-ecpayFamilyMartLimitationCheckout
@fixture-mobile-signup-p2 @fixture-shop @fixture-product @fixture-delivery @fixture-payment @fixture-promotion
Feature: Mobile member Checkout - Fit limitation with Ecpay (FamilyMart)
  As a customer
  ...
  Scenario: Checkout - Fit limitation with Ecpay (FamilyMart)
