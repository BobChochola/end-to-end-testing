@PostTest @PreTest @BaseCase @Admin @Storefront @Checkout @familyB2cCheckout
...
Feature: Familymart B2C Checkout
  ...
  Scenario: Checkout - FamilyMart B2C pickup and pay
    ...
    Then 1st product of products list should contain "7th Product for Checkou"
    And I should see product of products list
