@BaseCase @Storefront @Admin @Checkout @FastCheckout @fastCheckoutNoVariantProductToVariantsErrorMsgHandling 
...
Feature: Fast checkout error handling - no variant to variants
  As a customer
  ...
  Background:
    ...
    And I fill "(dirty data) no variant" to english name field
  ...
  @EAT-1274 @EAT-1274-11
  Scenario: Fast checkout error handling - no variant to variants
    Given I am on Shop Product Index Layout V Two Page
    When I hover over search icon
    When I input "no variant" to search field
    Then 1st product of products list should contain "no variant"
    ...
    Then 1st row of product list should contain "no variant"
    ...
    Then 1st row of product list should not contain 'no variant'
    Then 1st row of product list should not contain 'no variant'