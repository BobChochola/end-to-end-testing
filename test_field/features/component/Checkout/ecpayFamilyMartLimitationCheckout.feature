@PostTest @PreTest @Admin @BaseCase @Storefront @Checkout @ecpayFamilyMartLimitationCheckout
@fixture-payment @fixture-delivery @fixture-product @fixture-shop @fixture-promotion
Feature: Checkout - Fit limitation with Ecpay (FamilyMart)
  As a customer
  ...
  Scenario: Checkout - Fit limitation with Ecpay (FamilyMart)
    ...
    And I wait for 200 seconds for mail sent
