@BaseCase @Admin @Storefront @Checkout @promotionForAllShopCheckout
@fixture-payment @fixture-delivery @fixture-product @fixture-promotion @fixture-shop
Feature: Checkout with promotion for all of shop
  As a customer
  I want to use promotion for all of shop
  ...
  @C3821
  Scenario: Checkout with promotion for all of shop
