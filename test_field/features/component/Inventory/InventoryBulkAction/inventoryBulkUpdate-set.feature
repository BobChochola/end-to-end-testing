@PostTest @PreTest @BaseCase @Admin @Inventory @InventoryBulkAction @Product @inventoryBulkUpdate-set
Feature: Product Inventory Bulk Update - set
  ...
  @C3759 @C3759-1 @C3759-1-2
  Scenario: Bulk edit quantity - Set quantity
    Given I am on Product Create Page
    When I pick product photo to product photo selector
    Then I should see delete photo button
    And I click on info tab
    And I fill "(dirty data) Bulk Set Quantity" to english name field
    ...
    Then product list should not contain "Bulk Set Quantity"