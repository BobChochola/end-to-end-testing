@BaseCase @Admin @Domain @DomainSetting @updateDomainRegistrationHintWordings-Basic @fixture-basic-plan
Feature: check different plan apply customer domain popup wording - Basic
  As a merchant
  I want to customize the domain address
  So that I can see the correct hint wordings
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-10
  Scenario: check different plan apply customer domain popup wording - Basic
