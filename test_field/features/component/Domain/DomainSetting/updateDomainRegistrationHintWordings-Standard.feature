@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Standard @fixture-standard-plan
Feature: check different plan apply customer domain popup wording - Standard
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-7
  Scenario: check different plan apply customer domain popup wording - Standard
