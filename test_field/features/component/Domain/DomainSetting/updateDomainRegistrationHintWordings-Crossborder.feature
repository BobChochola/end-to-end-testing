@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Crossborder @fixture-crossborder-plan @baseLocation-HK
Feature: check different plan apply customer domain popup wording - Crossborder
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-6
  Scenario: check different plan apply customer domain popup wording - Crossborder
