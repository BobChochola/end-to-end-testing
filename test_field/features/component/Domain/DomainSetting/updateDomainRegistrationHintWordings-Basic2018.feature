@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Basic2018 @fixture-basic2018-plan
Feature: check different plan apply customer domain popup wording - Basic2018
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-8
  Scenario: check different plan apply customer domain popup wording - Basic2018
