@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Starter @fixture-starter-plan
Feature: check different plan apply customer domain popup wording - Starter
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-11
  Scenario: check different plan apply customer domain popup wording - Starter
