@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Business @fixture-business-plan
Feature: check different plan apply customer domain popup wording - Business
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-13
  Scenario: check different plan apply customer domain popup wording - Business
