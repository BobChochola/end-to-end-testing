@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Social @fixture-social-plan @fixture-domain-applicable
Feature: check different plan apply customer domain popup wording - Social
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-9
  Scenario: check different plan apply customer domain popup wording - Social
