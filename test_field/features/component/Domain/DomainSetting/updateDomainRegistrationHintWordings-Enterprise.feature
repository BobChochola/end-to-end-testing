@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Enterprise @fixture-enterprise-plan
Feature: check different plan apply customer domain popup wording - enterprise
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-2
  Scenario: check different plan apply customer domain popup wording - enterprise
