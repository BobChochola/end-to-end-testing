@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Advanced @fixture-advanced-plan @baseLocation-HK
Feature: check different plan apply customer domain popup wording - Advanced
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-5
  Scenario: check different plan apply customer domain popup wording - Advanced
