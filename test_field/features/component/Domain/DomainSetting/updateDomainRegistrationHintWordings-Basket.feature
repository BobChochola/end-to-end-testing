@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Basket @fixture-basket-plan
Feature: check different plan apply customer domain popup wording -Basket
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-12
  Scenario: check different plan apply customer domain popup wording -Basket
