@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Pro @fixture-pro-plan
Feature: check different plan apply customer domain popup wording - Pro
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-4
  Scenario: check different plan apply customer domain popup wording - Pro
