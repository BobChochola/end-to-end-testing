@BaseCase @Admin @Storefront @Domain @DomainSetting @updateDomainRegistrationHintWordings-Premium @fixture-premium-plan
Feature: check different plan apply customer domain popup wording - premium
  As a shopline
  ...
  @EAT-1169 @EAT-1169-1 @EAT-1169-1-1
  Scenario: check different plan apply customer domain popup wording - premium
