@PostTest @Storefront @LayoutEngine @checkLayoutEngineMerchant-robinmaybag @fixture-shop
Feature: check layout engine merchant - robinmaybag
  As a merchant
  ...
  @EAT-964 @EAT-964-3
  Scenario: check layout-shop: robinmaybag. theme: king
    Given I am on Shop Login Layout V Two Page
    Then I open new tab and redirect to robinmaybag shop
    ...
    Then I open new tab and redirect to robinmaybag product index page
    ...
    When I click on king checkout button
