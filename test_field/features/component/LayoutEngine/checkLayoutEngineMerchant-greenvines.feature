@PostTest @Storefront @LayoutEngine @checkLayoutEngineMerchant-greenvines @fixture-shop
Feature: check layout engine merchant - greenvines
  As a merchant
  ...
  @EAT-964 @EAT-964-1
  Scenario: check layout-shop: greenvines. theme: UltraChic
    Given I am on Shop Login Layout V Two Page
    Then I open new tab and redirect to greenvines shop
    ...
    Then I open new tab and redirect to greenvines product index page
