@PostTest @Storefront @LayoutEngine @checkLayoutEngineMerchant-lesenphants @fixture-shop
Feature: check layout engine merchant - lesenphants
  As a merchant
  ...
  @EAT-964 @EAT-964-4
  Scenario: check layout-shop: lesenphants. theme: UltraChic
    Given I am on Shop Login Layout V Two Page
    Then I open new tab and redirect to lesenphants shop
    ...
    Then I open new tab and redirect to lesenphants product index page
    ...
    Then I open new tab and redirect to lesenphants product index page
    Then I should be redirected to Shop Product Index Layout V Two Page
    When I click on 5th product of products list
    Then I should be redirected to Shop Product Show Layout V Two Page
    Then I check and click add to cart button
    Then I open new tab and redirect to lesenphants product index page
    Then I should be redirected to Shop Product Index Layout V Two Page
    When I click on 4th product of products list
    Then I should be redirected to Shop Product Show Layout V Two Page
    Then I check and click add to cart button
