@BaseCase @Admin @Storefront @Payment @MOLPay @molpayThailandCurrency-CreditCard @fixture-shop @fixture-product @fixture-delivery @baseLocation-TH
Feature: MOLpay THB currency payment endpoint adjustment - Credit Card
  As a merchant
  ...
  Background:
    ...
    And I fill "(dirty data) Credit Card via MOLPay" to name field
    And I click on add button

    And I click on confirm adding button
    Then I should be redirected to Payment Setting Page
    Then row of payment method list should contain '(dirty data) Credit Card via MOLPay'

  @EAT-1159 @EAT-1159-1
  Scenario: MOLpay THB currency payment endpoint adjustment - Credit Card
    ...
    And I wait for 5 seconds for loading
    And I select payment dropdown option included "(dirty data) Credit Card via MOLPay" of payment method dropdown
    And I wait for 5 seconds for loading
    ...
    Then row of payment method list should not contain '(dirty data) Credit Card via MOLPay'