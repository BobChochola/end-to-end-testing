@BaseCase @Admin @Storefront @Payment @MOLPay @molpayThailandCurrency-OnlineBanking @fixture-shop @fixture-product @fixture-delivery @baseLocation-TH
Feature: MOLpay THB currency payment endpoint adjustment - Online Banking
  As a merchant
  ...
  Background:
    ...
    And I select molpay payments dropdown option included "Online Banking / FPX" of molpay payments dropdown
    When I click on language tab included 'English'
    And I fill '(dirty data) Online Banking / FPX via MOLPay' to name field
    And I click on add button
    And I click on confirm adding button
    Then I should be redirected to Payment Setting Page
    Then row of payment method list should contain '(dirty data) Online Banking / FPX via MOLPay'

  @EAT-1159 @EAT-1159-2
  Scenario: MOLpay THB currency payment endpoint adjustment - Online Banking
    ...
    And I wait for 5 seconds for loading
    And I select payment dropdown option included "(dirty data) Online Banking / FPX via MOLPay" of payment method dropdown
    And I wait for 5 seconds for loading
    ...
    Then row of payment method list should not contain '(dirty data) Online Banking / FPX via MOLPay'