@PostTest @PreTest @BaseCase @Admin @Payment @Paypal @paymentCreatePaypal-HK
@baseLocation-HK
Feature: Payment Credit card or paypal Create Feature
  ...
  Scenario: Create payment - Credit card or paypal
    ...
    When I select payment type dropdown option included 'PayPal' of payment type dropdown
    And I fill "(dirty data) PayPal & Credit Card" to name field
    ...
    Then table should not contain '(dirty data) PayPal & Credit Card'