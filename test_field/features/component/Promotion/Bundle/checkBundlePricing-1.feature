@BaseCase @Storefront @Admin @Promotion @Bundle @checkBundlePricing-1
...
Feature: Checkout handle Bundle Pricing Apply
  ...
  @EAT-634 @EAT-634-1
  Scenario: Bundle Pricing buy 3 for 100, 6 for 180 (max 7)
    ...
    Then I should see cart panel price list
    ...
    Then I should see cart panel
    Then I should not see bundle item
    Then 2nd cart panel price list should contain "1x NT$100"
    Given I am on Shop Product Index Page
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 4th cart panel price list should contain "1x NT$10"
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    Then 2nd promotion list should contain "Buy 3 for $100"
    Then 3rd promotion list should contain "Buy 3 for $100"
    ...
    Then I scroll down to total list
    Then total list should contain "NT$111"
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 5th cart panel price list should contain "1x NT$25"
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    Then 2rd promotion list should contain "Buy 3 for $100"
    Then 3th promotion list should contain "Buy 3 for $100"
    Then 5th promotion list should contain "Buy 3 for $100"
    Then total list should contain "NT$121"
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 6th cart panel price list should contain "1x NT$50"
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    ...
    Then 4th promotion list should contain "Buy 6 for $180"
    Then 5th promotion list should contain "Buy 6 for $180"
    Then 6th promotion list should contain "Buy 6 for $180"
    Then total list should contain "NT$190"
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 5th cart panel price list should contain "2x NT$25"
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    Then 2nd promotion list should contain "Buy 6 for $180"
    Then 3rd promotion list should contain "Buy 6 for $180"
    ...
    Then 5th promotion list should contain "Buy 6 for $180"
    Then 6th promotion list should contain "Buy 6 for $180"
    Then total list should contain "NT$191"
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 7th cart panel price list should contain "1x NT$30"
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    Then 2nd promotion list should contain "Buy 6 for $180"
    Then 3rd promotion list should contain "Buy 6 for $180"
    Then 5th promotion list should contain "Buy 6 for $180"
    Then 6th promotion list should contain "Buy 6 for $180"
    Then 7th promotion list should contain "Buy 6 for $180"
    Then total list should contain "NT$201"
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 8th cart panel price list should contain "1x NT$49"
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    Then 2nd promotion list should contain "Buy 6 for $180"
    Then 5th promotion list should contain "Buy 6 for $180"
    Then 6th promotion list should contain "Buy 6 for $180"
    Then 7th promotion list should contain "Buy 6 for $180"
    Then 8th promotion list should contain "Buy 6 for $180"
    Then total list should contain "NT$211"
    Given I am on Shop Product Index Page
    When I input "18th Product for Checkout" to search field
    Then 1st product of products list should contain '18th Product for Checkout'
    When I click on 1st product of products list
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 2th cart panel price list should contain "2x NT$100"
    Given I am on Shop Product Index Page
    When I input "17th Product for Checkout" to search field
    Then 1st product of products list should contain '17th Product for Checkout'
    When I click on 1st product of products list
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 3th cart panel price list should contain "2x NT$10"
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 2th cart panel price list should contain "3x NT$100"
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    ...
    Then 7th promotion list should contain "Buy 6 for $180"
    Then 8th promotion list should contain "Buy 6 for $180"
    Then total list should contain "NT$271"
    ...
    And I click on add to cart button
    Then I should see cart panel
    Then 9th cart panel price list should contain "1x NT$59"
    When I click on checkout button
    Then I should be redirected to Shop Cart Page
    Then 2nd promotion list should contain "Buy 6 for $180"
    Then 6th promotion list should contain "Buy 6 for $180"
    Then 8th promotion list should contain "Buy 6 for $180"
    Then total list should contain "NT$301"
