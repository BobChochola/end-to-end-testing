@BaseCase @Admin @Storefront @Promotion @addDifferentProductApplyPromotion @fixture-shop @fixture-payment @fixture-delivery @fixture-addon @EAT-793 @fixture-different-promotion-with-product
Feature: buy 25 items for check bundlePricing Promotion is correct application
  ...
  Scenario: buy 25 items for check bundlePricing Promotion is correct application
    ...
    Then I should see addon item checkbox
    ...
    Then 6th item promotions should contain '(do not delete) Over $100~300 get $1~3 off'
    ...
    Then order summary should contain "Discount Applied:-NT$253"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$41'
    ...
    Then 6th item promotions should contain '(do not delete) Over $100~300 get $1~3 off'
    Then 7th item promotions should contain '(do not delete) Buy 3~21 for $30~210'
    Then 8th item promotions should contain '(do not delete) Buy 3~21 for $30~210'
    ...
    Then promotion description should contain '(do not delete) Over $100~300 get $1~3 off'
    Then promotion description should contain "-NT$208"
    ...
    Then order summary should contain 'Item Subtotal:NT$304'
    Then order summary should contain "Discount Applied:-NT$243"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$61'
    ...
    Then order summary should contain 'Item Subtotal:NT$404'
    ...
    Then order summary should contain 'Item Subtotal:NT$434'
    Then order summary should contain "Discount Applied:-NT$365"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$69'
    ...
    Then order summary should contain 'Item Subtotal:NT$533'
    Then order summary should contain "Discount Applied:-NT$274"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$259'
    ...
    Then promotion description should contain "-NT$61"
    ...
    Then order summary should contain 'Item Subtotal:NT$558'
    Then order summary should contain "Discount Applied:-NT$279"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$279'
    ...
    Then order summary should contain 'Item Subtotal:NT$568'
    Then order summary should contain "Discount Applied:-NT$279"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$289'

    And I click on 10th increase quantity button
    And I wait for 5 seconds for loading
    And I click on 10th increase quantity button
    And I wait for 5 seconds for loading
    Then 1st item promotions should contain '(do not delete) Buy 3~21 for $30~210'
    ...
    Then 7th item promotions should contain '(do not delete) Buy 3~21 for $30~210'
    Then 8th item promotions should contain '(do not delete) Buy 3~21 for $30~210'
    Then 10th item promotions should contain 'Promotion(do not delete) Over $100~300 get $1~3 off'
    ...
    Then order summary should contain 'Item Subtotal:NT$768'
    Then order summary should contain "Discount Applied:-NT$479"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$289'
    ...
    Then promotion description should contain "-NT$101"
    ...
    Then promotion description should contain "17th Free Gift Promotion"
    Then promotion description should contain "(do not delete) Over $50~100 get $9~28 off - Entire Order: Get NT$28 off over NT$100"
    Then promotion description should contain "-NT$28"
    Then promotion description should contain "2nd Free Shipping"

    Then order summary should contain 'Item Subtotal:NT$828'
    Then order summary should contain "Discount Applied:-NT$519"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$309'
    ...
    Then order summary should contain 'Item Subtotal:NT$1,268'
    Then order summary should contain "Discount Applied:-NT$519"
    Then order summary should contain 'Delivery Fee:NT$0'
    Then order summary should contain 'Total:NT$749'
    ...
    Then discount applied should contain '-NT$101'
    ...
    Then discount applied should contain '-'
    Then item subtotal should contain 'NT$1,268'
    Then item discount applied should contain '-NT$519'
    Then delivery fee should contain 'NT$0'
    Then total should contain 'NT$749'
