@BaseCase @Storefront @Admin @Promotion @BundleGroup @checkBundleGroupTagAtReturnOrder @EAT-998 @EAT-998-3
@fixture-shop @fixture-product @fixture-delivery @fixture-payment @fixture-promotion
Feature: Check bundle group tag at return order page.
  As a merchant
  ...
  Scenario: Check bundle group tag at return order page.
    ...
    Then I should see 3 bundle group tag
    And I click on all selected checkbox
    ...
    And I wait for 10 seconds loading
    ...
    When I input return number to search field
    And I wait for 3 seconds loading
    Then I should see row of mail list
    When I click on row of mail list included 'Your return order'
    Then order detail should not contain 'Bundle Group'
