@BaseCase @Admin @Storefront @Promotion @BundleGroup @Unstackable @Navigation @Menu @menuNavigationDisplayBundleGroupPricing-unstackable @fixture-product @fixture-shop @fixture-promotion
Feature: Set unstackable bundle group pricing menu navigation and check promotion name on storefront.
  As a merchant
  When Set unstackable bundle group pricing menu navigation and check correct data on storefront
  ...
  Scenario: Set unstackable bundle group pricing menu navigation and check promotion name on storefront.
    ...
    Then promotion name should contain 'Limited offer for your first set.'
    Then promotion name should not contain 'Buy more, Save more!'
    ...
    When I select 2nd product filter options included 'B 組商品' of product filter
    Then I should see 2 group b product
    Then I wait for 5 seconds loading 
    Then products list should contain '18th Product for Checkout'
    Then products list should contain '17th Product for Checkout'
