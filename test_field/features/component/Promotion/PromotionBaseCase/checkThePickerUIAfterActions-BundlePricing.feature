@PromotionBaseCase @Admin @Promotion @checkThePickerUIAfterActions-BundlePricing @EAT-1138 @C25690

Feature: Check the picker UI after actions - bundle pricing promotion
  ...
  @EAT-1138-4
  Scenario: check the picker UI after actions for bundle pricing promotion
    # add
    Given I am on Bundle Pricing Create Page
    When I select search type dropdown option included 'Search by Product Tags' of search type dropdown
