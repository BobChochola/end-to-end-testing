@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotion-NonApply-GetFreeShipping @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-amounts-bundle @EAT-1121 @C25702
Feature: All kind of over minimum amounts promotion - NonApply - get free shipping
  ...
  Scenario: Nonapply entire order over minimum amounts and get free shipping promotion
    ...
    Given I am on Free Shipping Index Page
    And I input 'Entire order over NT$225 get free shipping' to search field
    Then 1st row of free shipping list should contain 'Entire order over NT$225 get free shipping'
    ...
    When I fill '（rollback）Entire order over NT$226 get free shipping' to name field
    And I fill "226" to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then promotion name should equal to "（rollback）Entire order over NT$226 get free shipping"
    Then promotion limitations end date should contain "Never expires"
    Then discount summary should equal to "Enjoy free shipping with purchase over NT$226"
    ...
    Then promotion description should contain '-NT$15'
    Then promotion description should contain 'Entire order over NT$237 get 1 free gift'
    Then promotion description should not contain '（rollback）Entire order over NT$226 get free shipping'
    Then promotion description should not contain 'Entire order over NT$225 get free shipping'
    Then cart item subtotal should contain 'NT$348'
    Then applied store credits should contain '-NT$12'
    Then delivery fee should contain 'NT$10'
    Then total should contain 'NT$235'
    ...
    Then discount applied should not contain '（rollback）Entire order over NT$226 get free shipping'
    Then discount applied should not contain 'Entire order over NT$225 get free shipping'
    ...
    And ---ROLL BACK---
    Given I am on Free Shipping Index Page
    And I input 'Entire order over NT$226 get free shipping' to search field
    Then 1st row of free shipping list should contain 'Entire order over NT$226 get free shipping'
    Then I should see row of edit button
    And I click on row of edit button
    Then I should be redirected to Free Shipping Edit Page
    When I fill '[promotion basecase phase 1] - Entire order over NT$225 get free shipping' to name field
    And I fill "225" to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then promotion name should equal to "[promotion basecase phase 1] - Entire order over NT$225 get free shipping"
    Then promotion limitations end date should contain "Never expires"
    Then discount summary should equal to "Enjoy free shipping with purchase over NT$225"
    And I click on confirm button
    Then I should be redirected to Free Shipping Index Page
    Then I should see alert
    When I input 'promotion basecase phase 1' to search field
