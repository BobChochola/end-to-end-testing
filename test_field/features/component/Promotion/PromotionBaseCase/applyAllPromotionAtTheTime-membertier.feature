@PromotionBaseCase @Admin @Promotion @applyAllPromotionAtTheTime-membertier @fixture-product @fixture-addon @fixture-freegift @fixture-promotion @C25697
...
Feature: Promotion bundle and free shipping freegift at the same time
  ...
  @EAT-1054 @EAT-1054-3
  Scenario: Promotion bundle and free shipping freegift at the time - membertier
    ...
    Then I should see select product popup
    When I click checkbox of product list for the same order of product of popover list included '1st Created Free Gift'
    And I click on popup confirm button
