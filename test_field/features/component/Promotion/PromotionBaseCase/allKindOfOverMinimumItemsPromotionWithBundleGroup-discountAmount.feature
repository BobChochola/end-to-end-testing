@PromotionBaseCase @PromotionPreviewBaseCase @BaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumItemsPromotionWithBundleGroup-discountAmount @fixture-product
@fixture-shop @fixture-payment @fixture-delivery @fixture-promotion-basecase-minimum-items @fixture-promotion-basecase-minimum-item-discount-amount @EAT-1256 @C26852
Feature: All kind of over minimum items promotion with bundle group promotion - disount amount
  ...
  Background:
    ...
    When I fill '50' to add on items price field
    ...
    And I fill '386' to total order amount field
  ...
  Scenario: buy 11 items for check over Minimum items Promotion and Bundle Group Pricing Promotion should be applied correctly
    ...
    Then 5th item promotions should contain 'Entire order over 11 items selected categories get NT$11 off'
    ...
    Then 9th item promotions should contain 'Entire order over 11 items selected products get NT$4 off'
    Then 11st item promotions should contain 'Selected products over 1 items selected products get NT$51 off'
    Then 12nd item promotions should contain 'Selected categories over 1 items selected categories get NT$51 off'
    ...
    Then promotion description should contain 'Entire order over 11 items selected products get NT$4 off'
    Then promotion description should contain '-NT$4'
    Then promotion description should contain 'Selected products over 1 items selected products get NT$51 off'
    Then promotion description should contain '-NT$50'
    Then promotion description should contain 'Entire order over 11 items selected categories get NT$11 off'
    Then promotion description should contain '-NT$11'
    Then promotion description should contain 'Selected categories over 1 items selected categories get NT$51 off'
    Then promotion description should contain '-NT$50'
    ...
    Then promotion description should contain 'Entire order over 8 items get NT$33 off'
    Then promotion description should contain '-NT$33'
    ...
    Then promotion description should contain 'Selected category over 2 items get free shipping'
    Then promotion description should not contain 'Entire order over 11 items get free shipping'
    ...
    Then discount applied should contain 'Entire order over 11 items selected products get NT$4 off'
    Then discount applied should contain '-NT$4'
    Then discount applied should contain 'Selected products over 1 items selected products get NT$51 off'
    Then discount applied should contain '-NT$50'
    Then discount applied should contain 'Entire order over 11 items selected categories get NT$11 off'
    Then discount applied should contain '-NT$11'
    Then discount applied should contain 'Selected categories over 1 items selected categories get NT$51 off'
    Then discount applied should contain '-NT$50'
    ...
    Then discount applied should contain 'Entire order over 8 items get NT$33 off'
    Then discount applied should contain '-NT$33'
    ...
    Then discount applied should contain 'Selected category over 2 items get free shipping'
    Then discount applied should not contain 'Entire order over 11 items get free shipping'
    ...
    When I fill '100' to add on items price field
    And I click on save button
    Then I should be redirected to Cart Add On Items Index Page
    Then I should see alert
    When I click on 1st select checkbox of cart addon list
