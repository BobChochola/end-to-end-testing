@PromotionBaseCase @Admin @Promotion @sameTargetGroupsCantUsePromotion-All @fixture-product @fixture-promotion @C25693 @C25694
Feature: Same target groups can not use promotion bundle for a same product auto and affiliate campaign
  ...
  Background:
    ...
    When I fill "(dirty data) Test Free Shipping -3" to name field
    ...
    And I click on 3rd countinue to button
    And I click on preview button
    Then promotion name should equal to "(dirty data) Test Free Shipping -3"
  ...
  @EAT-1050 @EAT-1051 @EAT-1050-3 @EAT-1051-3
  Scenario: Same target groups can not use promotion bundle for a same product auto and affiliate campaign - All
    Given I am on Bundle Pricing Create Page
    ...
    When I click on add promotion button
    Then I should be redirected to Free Shipping Create Page
    When I fill "(dirty data) Test Free Shipping -3 test" to name field
    And I click on selected products condition checkbox
    And I fill '1' to promotion condition field
    When I fill '4th Product for Checkout' to search field
    And I click on search button
    ...
    And I click on 3rd countinue to button
    And I click on preview button
    Then promotion name should equal to "(dirty data) Test Free Shipping -3 test"
    And I click on confirm button
    Then I should see alert
    Then I should see alert
    Then I should be redirected to Free Shipping Index Page
    Then 1st row of promotion name should equal to '(dirty data) Test Free Shipping -3 test'
    Then 2nd row of promotion name should equal to '(dirty data) Test Free Shipping -3'
