@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotion-NonApply-SelectedCategory @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-amounts-bundle @EAT-1121 @C25702
Feature: All kind of over minimum amounts promotion - NonApply - selected categories
  ...
  @EAT-1121-2
  Scenario: Nonapply selected categories over minimum amounts promotion
    When I switch to 2 of tabs
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$258 selected categories get 20% off' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$258 selected categories get 20% off'
    ...
    When I fill '（rollback）Entire order over NT$259 selected categories get 20% off' to name field
    And I fill '259' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 20% off on Selected Categories with purchase over NT$259'
    ...
    Then 3rd item promotions should contain 'Buy 3 for $30'
    Then 4th item promotions should contain 'Entire order over NT$260 selected products get 15% off'
    Then 5th item promotions should not contain '（rollback）Entire order over NT$259 selected categories get 20% off'
    Then 6th item promotions should contain 'Buy 3 for $90'
    Then 7th item promotions should contain 'Buy 3 for $90'
    Then 8th item promotions should contain 'Buy 3 for $90'
    Then 10th item promotions should contain 'Entire order over NT$237 get 1 free gift'
    ...
    Then promotion description should contain 'Buy 3 for $90'
    Then promotion description should contain '-NT$53'
    Then promotion description should not contain '（rollback）Entire order over NT$259 selected categories get 20% off'
    Then promotion description should not contain 'Entire order over NT$258 selected categories get 20% off'
    Then promotion description should contain 'Entire order over NT$260 selected products get 15% off'
    Then promotion description should contain '-NT$2'
    Then promotion description should contain 'Entire order over NT$252 get 10% off'
    Then promotion description should contain '-NT$16'
    Then promotion description should contain 'Entire order over NT$237 get 1 free gift'
    Then promotion description should contain 'Entire order over NT$225 get free shipping'
    Then cart item subtotal should contain 'NT$348'
    Then delivery fee should contain 'NT$0'
    Then applied store credits should contain '-NT$13'
    Then total should contain 'NT$229'
    ...
    Then discount applied should not contain '（rollback）Entire order over NT$259 selected categories get 20% off'
    Then discount applied should not contain 'Entire order over NT$258 selected categories get 20% off'
    Then discount applied should contain 'Entire order over NT$260 selected products get 15% off'
    ...
    And ---ROLL BACK---
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$259 selected categories get 20% off' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$259 selected categories get 20% off'
    Then I should see edit dropdown
    When I select promotion option of edit dropdown
    Then I should be redirected to Promotion Edit Page
    When I fill '[promotion basecase phase 1] - Entire order over NT$258 selected categories get 20% off' to name field
    And I fill '258' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 20% off on Selected Categories with purchase over NT$258'
    And I click on confirm button
    Then I should see alert
    Then I should be redirected to Promotion Index Page
    When I input 'promotion basecase phase 1' to search field
