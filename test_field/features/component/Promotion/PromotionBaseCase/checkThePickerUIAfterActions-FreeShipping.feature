@PromotionBaseCase @Admin @Promotion @checkThePickerUIAfterActions-FreeShipping @EAT-1138 @C25690

Feature: Check the picker UI after actions - free shipping
  ...
  @EAT-1138-3
  Scenario: check the picker UI after actions for selected product free shipping
    # add
    ...
    When I select search by tag of search dropdown
    And I fill 'new' to search field
    And I click on search button
    Then I should see select product popup
    Then I should see checkbox of product list
    Then list of popup product should contain '(dirty data)New Product'
    ...
    Then I should see select product popup
    Then I should see checkbox of product list
    Then list of popup product should contain '(dirty data)New Edit Product'
    When I click on checkbox of product list
    And I click on popup confirm button
    Then I should see row of selected product
