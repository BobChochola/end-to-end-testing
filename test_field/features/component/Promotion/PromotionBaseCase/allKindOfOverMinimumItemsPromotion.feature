@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumItemsPromotion @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-promotion @fixture-freegift @EAT-934 @C25699

Feature: All kind of over minimum items promotion
  ...
  Background:
    ...
    Then 1st row of selected product should contain '4th Product for Checkou'
  ...
  Scenario: buy 8 items for check overMinimum Promotion is correct application
