@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotionWithBundleGroup-NonApply-SelectedCategory @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-amounts-bundle-group @EAT-1132 @C25723

Feature: All kind of over minimum amounts promotion with bundle group - NonApply - select categoris
  ...
  Scenario: Nonapply selected categories over minimum amounts promotion
    ...
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$327 selected categories get 20% off' to search field
    ...
    When I fill '（rollback）Entire order over NT$328 selected categories get 20% off' to name field
    And I fill '328' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 20% off on Selected Categories with purchase over NT$328'
    ...
    Then 5th item promotions should contain 'Buy 2 in Group A & 1 in Group B for $90'
    Then 6th item promotions should contain 'Buy 2 in Group A & 1 in Group B for $90'
    Then 7th item promotions should not contain '（rollback）Entire order over NT$328 selected categories get 20% off'
    Then 8th item promotions should contain 'Buy 2 in Group A & 1 in Group B for $90'
    Then 10th item promotions should contain 'Entire order over NT$286 get 1 free gift'
    ...
    Then promotion description should contain 'Buy 2 in Group A & 1 in Group B for $90'
    Then promotion description should contain '-NT$90'
    Then promotion description should not contain '（rollback）Entire order over NT$328 selected categories get 20% off'
    Then promotion description should not contain 'Entire order over NT$327 selected categories get 20% off'
    Then promotion description should contain 'Entire order over NT$329 selected products get 15% off'
    Then promotion description should contain '-NT$2'
    Then promotion description should contain 'Entire order over NT$307 get 10% off'
    Then promotion description should contain '-NT$23'
    Then promotion description should contain 'Entire order over NT$286 get 1 free gift'
    Then promotion description should contain 'Entire order over NT$271 get free shipping'
    Then cart item subtotal should contain 'NT$454'
    Then delivery fee should contain 'NT$0'
    Then applied store credits should contain '-NT$16'
    Then total should contain 'NT$288'
    ...
    Then discount applied should not contain '（rollback）Entire order over NT$328 selected categories get 20% off'
    Then discount applied should not contain 'Entire order over NT$327 selected categories get 20% off'
    ...
    And ---ROLL BACK---
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$328 selected categories get 20% off' to search field
    Then I should see edit dropdown
    When I select promotion option of edit dropdown
    Then I should be redirected to Promotion Edit Page
    When I fill '[promotion basecase phase 1] - Entire order over NT$327 selected categories get 20% off' to name field
    And I fill '327' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 20% off on Selected Categories with purchase over NT$327'
    And I click on confirm button
    Then I should see alert
    Then I should be redirected to Promotion Index Page
    ...
    When I click on assign credits button
    Then I should see popover
    When I fill "-4" to amount of credit field
