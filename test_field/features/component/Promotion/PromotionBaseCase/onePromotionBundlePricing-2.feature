@PromotionBaseCase @Admin @Storefront @Promotion @onePromotionBundlePricing-2
@fixture-product @fixture-promotion @fixture-shop @EAT-937 @C32210

Feature: Bundle pricing promotion price < discounted price
  ...
  Background:
    ...
    And I fill '(dirty data) Buy 3 for $50' to name field
    ...
    Then 1st row of promotions should contain 'Buy 3 for $50'
    ...
    And I select condition type dropdown option included 'Minimum items' of condition type dropdown
    ...
    Then 1st row of promotion list should contain 'Buy selected product for 2 items get 10% off'
    Then 1st row of promotion list should contain 'Never expires'

  Scenario: buy 5 items for check bundlePricing Promotion is correct application
    ...
    Then item subtotal should contain 'NT$102'
    Then item discount applied should contain '-NT$4'
