@Admin @Promotion @PromotionBaseCase @fixture-product @productSlectedByOnePromotion-AllMembers @fixture-promotion @C25691
Feature: Product only can selected by one promotion -  group by all members.
  As a merchant
  ...
  Background:
    ...
    Then target group should contain 'All Members'
