@PromotionBaseCase @Admin @Storefront @Promotion @onePromotionBundlePricing-1 @fixture-product @fixture-shop @fixture-promotion @EAT-931 @C32206
...
Feature: Bundle pricing promotion price > discounted price
  ...
  Scenario: buy 5 items for check bundlePricing Promotion is correct application
    ...
    Then total should contain 'NT$102'
