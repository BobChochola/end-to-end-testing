@PromotionBaseCase @PromotionPreviewBaseCase @BaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotionWithBundleGroup-discountPercent @fixture-product
@fixture-shop @fixture-payment @fixture-delivery @fixture-promotion-basecase-minimum-amounts-bundle-group
  @fixture-promotion-basecase-minimum-amount-discount-percent @EAT-1254 @C25706
Feature: All kind of over minimum amounts promotion with bundle group promotion - disount percent
  ...
  Scenario: buy 11 items for check over Minimum amounts Promotion and Bundle Group Pricing Promotion should be applied correctly
    ...
    Then 5th item promotions should contain 'Entire order over NT$572 selected categories get 20% off'
    ...
    Then 9th item promotions should contain 'Entire order over NT$584 selected products get 15% off'
    Then 11st item promotions should contain 'Selected products over NT$50 selected products get 15% off'
    Then 12nd item promotions should contain 'Selected categories over NT$50 selected categories get 20% off'
    Then 14th item promotions should contain 'Entire order over NT$519 get 1 free gift'
    ...
    Then promotion description should contain 'Entire order over NT$584 selected products get 15% off'
    Then promotion description should contain '-NT$4'
    Then promotion description should contain 'Selected products over NT$50 selected products get 15% off'
    Then promotion description should contain '-NT$8'
    Then promotion description should contain 'Entire order over NT$572 selected categories get 20% off'
    Then promotion description should contain '-NT$11'
    Then promotion description should contain 'Selected categories over NT$50 selected categories get 20% off'
    Then promotion description should contain '-NT$10'
    Then promotion description should contain 'Entire order over NT$519 get 1 free gift'
    ...
    Then promotion description should contain 'Entire order over NT$419 get 10% off'
    ...
    Then promotion description should contain 'Selected products over NT$85 get free shipping'
    Then promotion description should not contain 'Entire order over NT$480 get free shipping'
    Then promotion description should not contain 'Selected category over NT$100 get free shipping'
    ...
    Then discount applied should contain 'Entire order over NT$584 selected products get 15% off'
    Then discount applied should contain '-NT$4'
    Then discount applied should contain 'Selected products over NT$50 selected products get 15% off'
    Then discount applied should contain '-NT$8'
    Then discount applied should contain 'Entire order over NT$572 selected categories get 20% off'
    Then discount applied should contain '-NT$11'
    Then discount applied should contain 'Selected categories over NT$50 selected categories get 20% off'
    Then discount applied should contain '-NT$10'
    Then discount applied should contain 'Entire order over NT$519 get 1 free gift'
    ...
    Then discount applied should contain 'Entire order over NT$419 get 10% off'
    ...
    Then discount applied should contain 'Selected products over NT$85 get free shipping'
    Then discount applied should not contain 'Entire order over NT$480 get free shipping'
    Then discount applied should not contain 'Selected category over NT$100 get free shipping'
