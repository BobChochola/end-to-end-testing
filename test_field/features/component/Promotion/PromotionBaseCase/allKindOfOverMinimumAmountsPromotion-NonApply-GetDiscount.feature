@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotion-NonApply-GetDiscount @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-amounts-bundle @EAT-1121 @C25702
Feature: All kind of over minimum amounts promotion - NonApply - get discount
  ...
  @EAT-1121-3
  Scenario: Nonapply entire order over minimum amounts and get discount promotion
    When I switch to 2 of tabs
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$252 get 10% off' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$252 get 10% off'
    ...
    When I fill '（rollback）Entire order over NT$253 get 10% off' to name field
    And I fill '253' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 10% off on Entire Order with purchase over NT$253'
    ...
    Then promotion description should contain 'Entire order over NT$260 selected products get 15% off'
    Then promotion description should contain '-NT$6'
    Then promotion description should not contain 'Entire order over NT$253 get 10% off'
    Then promotion description should not contain 'Entire order over NT$252 get 10% off'
    Then promotion description should contain 'Entire order over NT$237 get 1 free gift'
    Then promotion description should contain 'Entire order over NT$252 get NT$13 off'
    Then promotion description should contain '-NT$13'
    Then promotion description should contain 'Entire order over NT$225 get free shipping'
    Then cart item subtotal should contain 'NT$348'
    Then delivery fee should contain 'NT$0'
    Then applied store credits should contain '-NT$12'
    Then total should contain 'NT$227'
    ...
    Then discount applied should not contain 'Entire order over NT$253 get 10% off'
    ...
    Then discount applied should contain 'Entire order over NT$252 get NT$13 off'
    ...
    And ---ROLL BACK---
    Given I am on Promotion Index Page
    And I input '（rollback）Entire order over NT$253 get 10% off' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$253 get 10% off'
    Then I should see row of edit button
    When I click on 1st row of edit button
    Then I should be redirected to Promotion Edit Page
    When I fill '[promotion basecase phase 1] - Entire order over NT$252 get 10% off' to name field
    And I fill '252' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 10% off on Entire Order with purchase over NT$252'
    And I click on confirm button
    Then I should see alert
    Then I should be redirected to Promotion Index Page
    When I input 'promotion basecase phase 1' to search field
