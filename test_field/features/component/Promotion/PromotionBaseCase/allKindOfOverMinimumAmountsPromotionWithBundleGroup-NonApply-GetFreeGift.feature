@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotionWithBundleGroup-NonApply-GetFreeGift @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-amounts-bundle-group @EAT-1132 @C25723

Feature: All kind of over minimum amounts promotion with bundle group - NonApply - get free gift
  ...
  @EAT-1132-4
  Scenario: Nonapply entire order over minimum amounts and get free gift promotion
    When I switch to 2 of tabs
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$286 get 1 free gift' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$286 get 1 free gift'
    ...
    When I fill '（rollback）Entire order over NT$287 get 1 free gift' to name field
    And I fill '287' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 1 Free Gift(s) (1st Created Free Gift) on Entire Order with purchase over NT$287'
    ...
    Then I should see 9 item promotions
    Then 1st item promotions should contain 'Buy 3 for $30'
    Then 2nd item promotions should contain 'Buy 3 for $30'
    Then 3rd item promotions should contain 'Buy 3 for $30'
    Then 4th item promotions should contain 'Entire order over NT$329 selected products get 15% off'
    ...
    Then promotion description should contain 'Entire order over NT$307 get 10% off'
    Then promotion description should contain '-NT$21'
    Then promotion description should not contain '（rollback）Entire order over NT$287 get 1 free gift'
    Then promotion description should not contain 'Entire order over NT$286 get 1 free gift'
    Then promotion description should contain 'Entire order over NT$271 get free shipping'
    Then cart item subtotal should contain 'NT$454'
    Then delivery fee should contain 'NT$0'
    Then applied store credits should contain '-NT$15'
    ...
    Then discount applied should not contain '（rollback）Entire order over NT$287 get 1 free gift'
    Then discount applied should not contain 'Entire order over NT$286 get 1 free gift'
    ...
    And ---ROLL BACK---
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$287 get 1 free gift' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$287 get 1 free gift'
    Then I should see row of edit button
    When I click on 1st row of edit button
    Then I should be redirected to Promotion Edit Page
    When I fill '[promotion basecase phase 1] - Entire order over NT$286 get 1 free gift' to name field
    And I fill '286' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 1 Free Gift(s) (1st Created Free Gift) on Entire Order with purchase over NT$286'
    And I click on confirm button
    Then I should see alert
    Then I should be redirected to Promotion Index Page
    When I input 'promotion basecase phase 1' to search field
