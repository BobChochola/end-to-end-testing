@Admin @Promotion @PromotionBaseCase @fixture-product @productCanNotSelectedByBundlePriceAndGroup-MemberTier @fixture-promotion @C25692
Feature: Product only can selected by bundle price and bundle group at the same time -  group by member tier.
  As a merchant
  ...
  @EAT-1049 @EAT-1049-5
  Scenario:First create bundle pricing and will see conflict message when creating bundle group.(Group by member tier)
    ...
    Then I click on checkbox of product list
    When I click on popup confirm button
    Then I should not see select product popup
  ...
  @EAT-1049 @EAT-1049-6
  Scenario:First create bundle group and will see conflict message when creating bundle pricing.(Group by member tier)
    Given I am on Bundle Group Create Page
    And I fill '(dirty data) bundle group(selected 2nd, 3rd, 7th)' to name field
    When I fill '2' to group a field
    When I fill '1' to group b field
