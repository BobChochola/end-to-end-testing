@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotionWithBundleGroup-NonApply-GetFreeShipping @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-amounts-bundle-group @EAT-1132 @C25723

Feature: All kind of over minimum amounts promotion with bundle group - NonApply - get free shipping
  ...
  @EAT-1132-5
  Scenario: Nonapply entire order over minimum amounts and get free shipping promotion
    When I switch to 2 of tabs
    Given I am on Free Shipping Index Page
    And I input 'Entire order over NT$271 get free shipping' to search field
    Then 1st row of free shipping list should contain 'Entire order over NT$271 get free shipping'
    Then I should see row of edit button
    And I click on row of edit button
    Then I should be redirected to Free Shipping Edit Page
    When I fill '（rollback）Entire order over NT$272 get free shipping' to name field
    And I fill "272" to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then promotion name should equal to "（rollback）Entire order over NT$272 get free shipping"
    Then promotion limitations end date should contain "Never expires"
    Then discount summary should equal to "Enjoy free shipping with purchase over NT$272"
    ...
    Then promotion description should contain 'Entire order over NT$307 get 10% off'
    Then promotion description should contain '-NT$21'
    Then promotion description should not contain '（rollback）Entire order over NT$272 get free shipping'
    Then promotion description should not contain 'Entire order over NT$271 get free shipping'
    ...
    Then discount applied should not contain '（rollback）Entire order over NT$272 get free shipping'
    Then discount applied should not contain 'Entire order over NT$271 get free shipping'
    Then discount applied should contain 'Entire order over NT$327 selected categories get 20% off'
    Then discount applied should contain 'Entire order over NT$329 selected products get 15% off'
    ...
    Then total should contain 'NT$321'

    And ---ROLL BACK---
    Given I am on Free Shipping Index Page
    And I input 'Entire order over NT$272 get free shipping' to search field
    Then 1st row of free shipping list should contain 'Entire order over NT$272 get free shipping'
    Then I should see row of edit button
    And I click on row of edit button
    Then I should be redirected to Free Shipping Edit Page
    When I fill '[promotion basecase phase 1] - Entire order over NT$271 get free shipping' to name field
    And I fill "271" to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then promotion name should equal to "[promotion basecase phase 1] - Entire order over NT$271 get free shipping"
    Then promotion limitations end date should contain "Never expires"
    Then discount summary should equal to "Enjoy free shipping with purchase over NT$271"
    And I click on confirm button
    Then I should see alert
    Then I should be redirected to Free Shipping Index Page
    When I input 'promotion basecase phase 1' to search field
