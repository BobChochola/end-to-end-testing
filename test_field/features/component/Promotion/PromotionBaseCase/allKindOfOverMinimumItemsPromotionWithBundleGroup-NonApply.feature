@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumItemsPromotionWithBundleGroup-NonApply @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-items @EAT-1130 @C25721
Feature: All kind of over minimum items promotion with bundle group promotion
  As a user of Shopline
  I want to check the promotion would not being applied
  When the minimum items limit does not reach
  ...
  Scenario: buy 9 items for check over minimum items promotion should not being applied
    ...
    Then promotion description should not contain 'Entire order over 9 items get free shipping'
    ...
    Then item discount applied should contain '-NT$125'
    Then applied store credits should contain '-NT$17'
    Then delivery fee should contain 'NT$10'
    Then total should contain 'NT$322'
    ...
    When I click on assign credits button
    Then I should see popover
    When I fill "-3" to amount of credit field
