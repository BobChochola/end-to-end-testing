@PromotionBaseCase @Admin @Storefront @Promotion @twoPromotionBundlePricing-1 @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-promotion @EAT-933 @C32208
...
Feature: The second bundle pricing promotion price > discounted price
  ...
  Scenario: buy 7 items for check bundlePricing Promotion is correct application
    ...
    Then 4th item promotions should contain 'Buy 3 for $90'
    ...
    Then promotion description should not contain 'Buy selected product for 2 items get 10% off'
    ...
    Then item discount applied should contain '-NT$16'
    Then total should contain 'NT$131'
