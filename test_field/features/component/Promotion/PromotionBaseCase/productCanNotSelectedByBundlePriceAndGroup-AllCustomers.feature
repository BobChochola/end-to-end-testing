@Admin @Promotion @PromotionBaseCase @fixture-product @productCanNotSelectedByBundlePriceAndGroup-AllCustomers @fixture-promotion @C25692
Feature: Product only can selected by bundle price and bundle group at the same time -  group by all customers.
  As a merchant
  ...
  @EAT-1049 @EAT-1049-1
  Scenario:First create bundle pricing and will see conflict message when creating bundle group.(Group by all customers)
  ...
  @EAT-1049 @EAT-1049-2
  Scenario:First create bundle group and will see conflict message when creating bundle pricing.(Group by all customers)
    Given I am on Bundle Group Create Page
    And I fill '(dirty data) bundle group(selected 2nd, 3rd, 7th)' to name field
    When I fill '2' to group a field
    When I fill '1' to group b field
