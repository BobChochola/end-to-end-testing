@PromotionBaseCase @Admin @Promotion @checkThePickerUIAfterActions-AddonItem @EAT-1138 @C25690

Feature: Check the picker UI after actions - add-on item
  ...
  @EAT-1138-6
  Scenario: check the picker UI after actions for assigning add-on item to main product
    # add
    ...
    Then I should see alert
    Then I wait for 5 seconds for sync
    ...
    When I select categories list dropdown option included '(dirty data)New Category' of categories list dropdown
    ...
    Then I should see row of products
    Then 1st row of products should contain '(dirty data)New Product'
    ...
    Given I am on Addon Create Page
    When I click on tab included 'Product Level Settings (Optional)'
    When I fill '(dirty data)New Edit Product' to search field
    And I click on search product button
    Then I should see select product popup
    ...
    And I click on confirm button
    Then I should see row of products
    Then 1st row of products should contain '(dirty data)New Edit Product'
    ...
    Then ---I NEED TO ROLLBACK row of products---
