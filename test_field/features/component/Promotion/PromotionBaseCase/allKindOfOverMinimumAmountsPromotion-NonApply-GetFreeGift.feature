@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotion-NonApply-GetFreeGift @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-amounts-bundle @EAT-1121 @C25702
Feature: All kind of over minimum amounts promotion - NonApply - get free gift
  ...
  Scenario: Nonapply entire order over minimum amounts and get free gift promotion
    ...
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$237 get 1 free gift' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$237 get 1 free gift'
    ...
    When I fill '（rollback）Entire order over NT$238 get 1 free gift' to name field
    And I fill '238' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 1 Free Gift(s) (1st Created Free Gift) on Entire Order with purchase over NT$238'
    ...
    Then promotion description should contain 'Entire order over NT$252 get 10% off'
    Then promotion description should contain '-NT$15'
    Then promotion description should not contain '（rollback）Entire order over NT$238 get 1 free gift'
    Then promotion description should not contain 'Entire order over NT$237 get 1 free gift'
    Then promotion description should contain 'Entire order over NT$225 get free shipping'
    Then cart item subtotal should contain 'NT$348'
    Then delivery fee should contain 'NT$0'
    Then applied store credits should contain '-NT$12'
    ...
    Then discount applied should not contain '（rollback）Entire order over NT$238 get 1 free gift'
    Then discount applied should not contain 'Entire order over NT$237 get 1 free gift'
    ...
    And ---ROLL BACK---
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$238 get 1 free gift' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$238 get 1 free gift'
    Then I should see row of edit button
    When I click on 1st row of edit button
    Then I should be redirected to Promotion Edit Page
    When I fill '[promotion basecase phase 1] - Entire order over NT$237 get 1 free gift' to name field
    And I fill '237' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 1 Free Gift(s) (1st Created Free Gift) on Entire Order with purchase over NT$237'
    And I click on confirm button
    Then I should see alert
    Then I should be redirected to Promotion Index Page
    When I input 'promotion basecase phase 1' to search field
