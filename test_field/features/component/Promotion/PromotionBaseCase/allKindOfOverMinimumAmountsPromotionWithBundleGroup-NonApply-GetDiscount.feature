@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotionWithBundleGroup-NonApply-GetDiscount @fixture-product @fixture-shop @fixture-payment @fixture-delivery @fixture-freegift @fixture-promotion-basecase-minimum-amounts-bundle-group @EAT-1132 @C25723

Feature: All kind of over minimum amounts promotion with bundle group - NonApply - get discount
  ...
  Scenario: Nonapply entire order over minimum amounts and get discount promotion
    ...
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$307 get 10% off' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$307 get 10% off'
    ...
    When I fill '（rollback）Entire order over NT$308 get 10% off' to name field
    And I fill '308' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 10% off on Entire Order with purchase over NT$308'
    ...
    Then promotion description should contain 'Buy 2 in Group A & 1 in Group B for $90'
    Then promotion description should contain '-NT$90'
    Then promotion description should not contain '（rollback）Entire order over NT$308 get 10% off'
    Then promotion description should not contain 'Entire order over NT$307 get 10% off'
    Then promotion description should contain 'Entire order over NT$329 selected products get 15% off'
    Then promotion description should contain '-NT$2'
    Then promotion description should contain 'Entire order over NT$327 selected categories get 20% off'
    Then promotion description should contain '-NT$20'
    ...
    Then delivery fee should contain 'NT$0'
    Then applied store credits should contain '-NT$15'
    Then total should contain 'NT$279'
    ...
    Then discount applied should not contain '（rollback）Entire order over NT$308 get 10% off'
    Then discount applied should not contain 'Entire order over NT$307 get 10% off'
    ...
    And ---ROLL BACK---
    Given I am on Promotion Index Page
    And I input 'Entire order over NT$308 get 10% off' to search field
    Then 1st row of promotion list should contain 'Entire order over NT$308 get 10% off'
    Then I should see row of edit button
    When I click on 1st row of edit button
    Then I should be redirected to Promotion Edit Page
    When I fill '[promotion basecase phase 1] - Entire order over NT$307 get 10% off' to name field
    And I fill '307' to promotion condition field
    And I click on countinue to button
    And I click on 2nd countinue to button
    And I click on 3rd countinue to button
    And I click on preview button
    Then discount summary should equal to 'Get 10% off on Entire Order with purchase over NT$307'
    And I click on confirm button
    Then I should see alert
    Then I should be redirected to Promotion Index Page
    When I input 'promotion basecase phase 1' to search field
