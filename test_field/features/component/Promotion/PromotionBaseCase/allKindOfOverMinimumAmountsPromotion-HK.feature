@PromotionBaseCase @Admin @Storefront @Promotion @allKindOfOverMinimumAmountsPromotion-HK @fixture-product
@fixture-shop @fixture-payment @fixture-delivery @fixture-promotion-basecase-minimum-amounts-bundle @baseLocation-HK @EAT-1122 @C32222
Feature: All kind of over minimum amounts promotion - HK
  ...
  Scenario: buy 8 items for check overMinimum Promotion should apply correctly
    ...
    Given I am on Shop Product Index Page
    And I input '12nd Product for Checkout' to search field
    Then 1st product of products list should contain '12nd Product for Checkout'
    When I click on 1st product of products list
    Then I should be redirected to Shop Product Show Page
    When I click on add to cart button
    Then I should see cart panel
    ...
    Given I am on Shop Product Index Page
    And I input '13rd Product for Checkout' to search field
    Then 1st product of products list should contain '13rd Product for Checkout'
    When I click on 1st product of products list
    Then I should be redirected to Shop Product Show Page
    When I click on add to cart button
    Then I should see cart panel
    ...
    Then 10th item promotions should contain 'Entire order over HK$241.49 get 1 free gift'
    ...
    Then promotion description should contain 'Entire order over HK$241.49 get 1 free gift'
    Then promotion description should contain 'Entire order over HK$257.10 get 10% off'
    Then promotion description should contain '-HK$15.61'
    Then promotion description should not contain 'Entire order over HK$257.10 get HK$15.60 off'
    Then promotion description should contain 'Entire order over HK$228.49 get free shipping'
    ...
    Then discount applied should contain 'Entire order over HK$257.10 get 10% off'
    Then discount applied should contain '-HK$15.61'
    Then discount applied should not contain 'Entire order over HK$257.10 get HK$15.60 off'
    Then discount applied should contain 'Entire order over HK$241.49 get 1 free gift'
    Then discount applied should contain 'Entire order over HK$228.49 get free shipping'
    Then item subtotal should contain 'HK$376.91'
    Then item discount applied should contain '-HK$135.42'
    Then applied store credits should contain '-HK$13.00'
    Then delivery fee should contain 'HK$0'
    Then total should contain 'HK$228.49'
