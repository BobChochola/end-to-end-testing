...
class FreeShippingEditPage extends Page {

  get elements() {

    return {
      'id': this.by.css('div.promotion-section.general_info'),
      ...
      'purchase condition dropdown': this.by.css('div[ng-hide*="set_criteria"] .discount-criteria-container'),
  ...
  get samples() {
    ...
    return {
      ...
      'free shipping promotions name': 'Enjoy free shipping with purchase over NT$200',
...
module.exports = FreeShippingEditPage