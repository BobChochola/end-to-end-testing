...
class CustomOrderNotificationPage extends Page {
  ...
  get elements() {
    ...
    return {
      ...
      'english email picture':this.by.css('img[src*="ORDER_STATUS_UPDATE_EMAIL_en.jpg"]'),
      'zh email picture':this.by.css('img[src*="ORDER_STATUS_UPDATE_EMAIL_zh-hant.jpg"]'),
  ...
  get url() {
    ...
    return `${this.props.baseURL}/admin/${this.props.account.handle}/custom_notification/edit/ORDER_DELIVERY_STATUS_UPDATE?locale=en`

  }

}

module.exports = CustomOrderNotificationPage
